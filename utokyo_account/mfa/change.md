...
以下では，多要素認証の本人確認方法を変更する手順について説明します．
...
なお，Microsoft AuthenticatorやGoogle Authenticatorなどの認証アプリには「変更」画面がありません．認証アプリの登録を変更したい場合は，代わりに新しい本人確認方法を登録してから古い本人確認方法の項目を削除するという操作を行ってください．
