...
リセットが行われると，そのあと初めてUTokyo Accountにサインインする際に，あらためて本人確認方法の初期設定を行うよう求められます．上の「多要素認証の初期設定方法」の「[手順2：1個目の本人確認方法を設定する](#initial-first)」および「[手順3：追加の本人確認方法を設定する](#initial-alternative)」の手順で新しい本人確認方法を設定し，今後はそれを利用してUTokyo Accountにサインインしてください．
