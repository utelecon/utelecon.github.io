...
<div class="very-important-box">9月27日21時30分現在，認証基盤のトラブルにより，多要素認証を利用しているユーザのサインインができなくなっており，対処をしております．ご迷惑をお掛けして申し訳ありません．そのため，新たな多要素認証の設定はできません．ご注意ください．</div>
