...
このページでは，[UTokyo Accountの多要素認証](.)について，故障や機種変更などで本人確認方法が使えずに多要素認証によるサインインができなくなった場合のための手続きと，多要素認証の利用を終了したい場合の手続きについて説明をしています．それぞれ異なる手続きですので，自身に必要な手続きがどちらであるか確認し，手続きを行ってください．

- 本人確認方法が使えずにサインインができなくなった場合：まず，他の本人確認方法が利用できるか試します．もし利用できる本人確認方法が無ければ「**本人確認方法の再登録**」を行います．本人確認方法の登録をやり直し，多要素認証を引き続き使えるようにする手続きです．
- 多要素認証の利用を終了したい場合：「多要素認証の**利用終了**」を行います．多要素認証の利用をやめ，パスワードだけでサインインできる状態に戻す手続きです．セキュリティの観点から多要素認証を利用することを推奨しておりますが，やむを得ない事情がある場合には利用終了手続きを受け付けます．なお利用終了すると，多要素認証の利用が必須な[UTokyo VPN](/utokyo_vpn/)および[UTokyo Slack](/slack/)は利用できなくなります．
