...
また，多要素認証の有効化は，自身の操作では元に戻すことができません．多要素認証の利用をやめてパスワードだけでサインインできる状態に戻したい場合，「多要素認証の利用終了」という手続きが必要ですので，「[UTokyo Account多要素認証の本人確認方法再登録および利用終了について](failure_and_terminate)」を参照してください．
