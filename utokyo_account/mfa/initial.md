---
title: UTokyo Account多要素認証の初期設定
css: [mfa]
---

多要素認証 (Multi-Factor Authentication, MFA) とは，アカウントへのサインイン時に，パスワードに加えて，SMSや専用のアプリなどで本人確認を行う認証方法です．UTokyo Accountで多要素認証を利用している間は，UTokyo Accountにサインインする際，毎回，設定したSMSや専用のアプリなどで本人確認することが求められます．

このページでは，UTokyo Accountの多要素認証を利用するために最初に行う手続きを説明します．流れは以下のようになります：
- 本人確認方法を複数登録する
- サインインできるか確認する
- 利用申請を行う
- 設定がシステムに反映されるまで（最大40分）待機する

多要素認証を有効化するにあたって，**本人確認方法を2つ以上登録してください**．例えば，専用のアプリによる方法を登録したのち，SMSによる方法を登録します．これにより，いずれかの本人確認方法が使えなくなった場合に，他の方法でサインインできます．また，全ての手順を行った後は**設定がシステムに反映されるまで待機する必要があります**．
...
ここまでの手順で，本人確認方法を複数登録したこと，利用申請がシステムに反映されるまで待機したことを確認してください．
- 本人確認方法を1つしか登録していないと，その方法が使えなくなった場合に手続きが必要となります．
- 利用申請がシステムに反映されるまでは最大40分かかり，それまでは多要素認証が必要なサービスは利用できません．
