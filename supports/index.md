...
* Zoomを用いたサポート
  * **時間・内容を限定した試行サービスです．**学生（コモンサポーター）がオペレータとして対応し，音声・チャット・画面共有を利用して質問・相談を受け付けます．
* QA フォーラム
...
1. まず，[よくある質問（FAQ）](/faq)を読んで，似たトラブルがないか探してください
...
また，試行サービスとして，Zoomによるサポートを行っています．   
...
* チャットサービスについて
  ...
  * チャットボットでの問題解決が困難であると判断された場合，オペレータにつながります．
    * オペレータへの接続に先立って，所属や名前などの記入を促されるので，指示に従って記入してください．
  * チャットでは解決できない場合は，次のメールでのサポートに進んでください．
* 注意事項
  * チャットサービスでは，必要に応じて学生（コモンサポーター）がオペレータとして対応します．また，同時に対応できる人数には限りがあります．
    * そのため，原則として試験に関する質問には対応致しません．試験に関する質問や相談は，担当教員または開講学部・研究科に連絡してください．
  * 長期休業中のオペレータの対応時間は，原則として平日の10時20分から16時45分までですが，シフトの関係上対応できない時間帯が発生する可能性があることご了承ください（チャットボットによるサポートは24時間受け付けています）．
...
**時間・内容を限定した試行サービスです．**予告なくサービスを変更・停止することがあります．

* Zoomを用いたサポートについて   
  * 2/8以降，平日の10:20-16:45に開室します．ただし，シフトの関係上この時間中でも開室しない場合があること，ご了承ください．   
  * 以下の内容を確認した上で，下のリンク先に掲載している会議室情報でアクセスしてください．   
...
* 注意事項   
  * 原則として試験に関する質問には対応致しません．試験に関する質問や相談は，担当教員または開講学部・研究科に連絡してください．    
  * サポーターによる会議室での録音・録画は行いません．利用者も録音・録画等の行為を行わないでください．   
  * 個人情報の取り扱いには十分注意してください．具体的には，共通IDや学籍番号などは明かさないようにしてください．   
  * 問題解決にこれらの個人情報が必要と判断された場合は，オペレータがメールでの問い合わせを案内します．以下の記載に従って，メールでお問い合わせください．   
