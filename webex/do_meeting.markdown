...
* **共同主催者（9/16～）**： イベントの終了をする他，プレゼンター権限の設定，ブレイクアウトセッションの制御，参加者のロビーへの移動・入場をすることができます．また，参加者のマイクミュートの設定もできますが，参加者が自分で解除することもできます．（主催者と比べると，録画の制御，イベントの開始ができないくらいで後はだいたい一緒です．）
