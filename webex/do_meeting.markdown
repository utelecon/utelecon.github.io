...
* **主催者**： イベントの開始・終了をする他，プレゼンター権限の設定，ブレイクアウトセッションの制御，参加者のロビーへの移動・入場，Slidoの起動，録画をすることができます．また，参加者のマイクミュートの設定もできますが，参加者が自分で解除することもできます．
* **共同主催者**： 主催者と同等の権限を持ち，主催者のアシスタントとして，会議の進行を円滑にすることができます．
