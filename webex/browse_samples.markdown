...
トピックで区切ってクイズをはさむところを考えておきさえすれば，授業で使っているスライド等はほぼそのまま使えます．

*　**クイズの用意** 
Zoomの場合,投票機能を使ってあらかじめ各トピックの確認問題を作成しておきます.学生の理解度を図る上でも,また,学生の集中力を維持する上でも効果的です．挙手により発言をさせることもインタラクションの一つですが，オンラインの場合は，全員が参加できるクイズは積極的に活用すると良いでしょう，
