...
* 現在のWebexサービスでは2種類のサービスが利用可能です。
	* 90日の無償サービス（2020年6月8日まで利用可能）
		* Webex MeetingsとWebex Eventsが同時接続可能数は1000で利用できます．（ただし、通常のWebexで利用可能な最大200台までテレビ会議システム（いわゆるPolycom等）との接続はできません。）
		* 参考：[UTokyo 90 Days Cisco Webex](https://www.u-tokyo.ac.jp/adm/dics/ja/90dayswebex.html)
	* 180日の無償サービス（2020年9月10日ごろまで利用可能）
		* End to End 暗号化された会議が開けます. [Webex Meetingsを使った安全な会議の開き方](encrypted_meeting.html)
