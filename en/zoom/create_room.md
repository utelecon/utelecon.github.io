...
![](/zoom/create_room/2.png){:.medium}  
![](/zoom/create_room/3.png){:.medium}  

3. After saving, copy and send out **the invite link** to participants via email.  
![](/zoom/create_room/4.png){:.medium}  
...
![](/zoom/create_room/auth/meeting_1.png){:.medium} 
...
![](/zoom/create_room/auth/meeting_2.png){:.medium}
