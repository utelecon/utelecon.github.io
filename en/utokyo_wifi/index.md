...
<ul class="gap">
  ...
  <li>
    <strong>Step3: Apply for a UTokyo WiFi Account</strong>
...
- [UTokyo-CERT](https://cert.u-tokyo.ac.jp/e/index.html) may contact the user by email if it detected communication  that may cause a security problem.
