...
画面右の![](20.png){:.logo}アイコンから「Upload file」を選び、挿入したいファイルを選択することもできます。
...
モバイル版の場合、右上部の![](20.png){:.logo}アイコンから「Upload file」を選び、携帯電話に保存されている画像を選択して挿入できます。
...
画面右の![](20.png){:.logo}アイコンから「Drawing」を選び、ドローイング画面を表示します。
...
モバイル版の場合、右上部の![](20.png){:.logo}アイコンから「drawing」を選び、同様の操作が可能です。
