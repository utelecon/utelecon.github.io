...
【概要】今回より，Sセメスターで優れた工夫・取り組みのあった授業(グッドプラクティス)で紹介されている工夫・取り組みについて，実際に授業を行った先生方にご登場頂き，情報共有をいただきます．グッドプラクティスの内容は，当ポータル内の「 教育用ICT > グッドプラクティス（[リンク](https://utelecon.github.io/good-practice/) ）」にて，紹介しております．  <br>
