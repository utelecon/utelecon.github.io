...
なお，アプリからサインインする場合は手順が異なりますので，[Zoom サインイン方法](https://utelecon.adm.u-tokyo.ac.jp/zoom/signin)のページをご覧ください（アプリでのサインインは，同時にPC・タブレット・スマートフォンの各1台までとなっていることにご注意ください）．
