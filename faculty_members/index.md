...
* ひとつは, [東京大学で利用できる教育のためのICTシステム](#utokyo-edu-ict)を, 正しく使えるようにすることです. 語りかけるような文章が必要？
* もうひとつは, [Web会議システム](#webconf)につなげる機器を準備し，Web会議に[ちゃんとつなげることを確認しておく](#check-online-ready)ことです. 語りかけるような文章が必要？
 ...
 * **作業:** ITC-LMS [教員向けページ](../lms_lecturers/)の指示に従い, お知らせの通知先を設定して下さい. [手順動画TODO](https://youtu.be/xAur5zar5Sc)
