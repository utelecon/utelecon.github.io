...
東京大学では，オンライン授業の練習や情報収集などを支援する学生スタッフの制度「クラスサポーター」を実施しています．TAよりは軽めの内容で，全学の学生から募集して，制度の利用を希望する教員とマッチングします．詳細は「[クラスサポーター制度のご案内](supporters/class_2022)」をご覧ください．
