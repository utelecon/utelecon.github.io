...
description: このページでは，新たに東京大学でオンライン授業を始める教員を対象に，必要な事前準備を順序立てて説明しています．
---

<b class="box">
3/16 15:00から，説明会「<a href="/events/2022-03-16/">オンライン授業だけじゃない！　教育研究用ICT・オンライン会議ツールの説明会</a>」を開催します．終了後は録画も提供します．本ページとあわせてご参照ください．
</b>
...
なお，アプリからサインインする場合は手順が異なりますので，[Zoom サインイン方法](https://utelecon.adm.u-tokyo.ac.jp/zoom/zoom_signin)のページをご覧ください（アプリでのサインインは，同時にPC・タブレット・スマートフォンの各1台までとなっていることにご注意ください）．
...
東京大学では，「[情報倫理・コンピュータ利用ガイドライン](https://www.u-tokyo.ac.jp/adm/cie/ja/index.html)」にて，コンピュータについて「適切なウイルス対策」をすることを求めています．対策の一環として，2022年4月1日（予定）よりウイルス対策ソフトウェアの包括ライセンスを提供しますので，適宜利用してください．
...
東京大学では，オンライン授業の練習や情報収集などを支援する学生スタッフの制度「クラスサポーター」を実施しています．TAよりは軽めの内容で，全学の学生から募集して，制度の利用を希望する教員とマッチングします．詳細は「[クラスサポーター制度 のご案内](supporters/class_2022)」をご覧ください．
