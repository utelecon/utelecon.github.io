...
* **手書き板書用のホワイトボードツール** [<a href="https://www-ui.is.s.u-tokyo.ac.jp/~takeo/inklecture/index-j.html" target="_blank">html</a>] (情報理工学系研究科・五十嵐先生): タブレットＰＣやディスプレイタブレットを使用して板書でオンライン講義を行うためのツール（ソフトウェア）が紹介されています。
