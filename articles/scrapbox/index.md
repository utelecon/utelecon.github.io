...
リンクやハッシュタグが付けられた文字列は，

* 同じ名前のページが存在するとき
 （ハッシュタグの場合は先頭の`#`を除いた部分がページの名前になります）
* ほかのページに同じ名前のリンク，またはハッシュタグが存在するとき

は青色，それ以外の場合はオレンジ色で表示されます．

<figure>
<img src="11.png">
</figure>

リンクやハッシュタグが付けられた文字列をクリックすると，それぞれの文字列がタイトルとなったページに移動できます．   
