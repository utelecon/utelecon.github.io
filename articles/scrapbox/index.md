...
Googleアカウントと連携されると，Scrapboxのアカウント設定画面に切り替わります．「Name」と「Username」をそれぞれ入力してください．
...
Scrapboxにおけるページとは，プロジェクト内に蓄積されるwikiの単位です．授業で活用する場合は，授業ごとにページを作成すると良いでしょう．
...
ページを作成したいプロジェクトのページに移動してから，画面上部の![](7.png){:.logo}ボタンをクリックすることでページを作成することができます．

以下では，ページの作り方と編集方法を説明します．
