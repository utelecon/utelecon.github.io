...
GoodNotes 5では，PowerPointなどで作成したファイル(PDF化した状態で)を読み込んで，そこに書き込みを加えていくことができます．
...
本記事では詳述しませんが，「AirPlay（またはそのミラーリングソフト）」を用いた画面共有等の方法を用いることで，Macや一部のWidowsPCからiPadの画面を共有することも可能です．
