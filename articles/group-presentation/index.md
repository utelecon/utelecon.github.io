...
なお，この共有をする際にはグループ全員が共同編集をできるようにしておくと便利です．詳しくは以下の記事をご覧ください．(参考：[Googleドライブの使い方](https://utelecon.adm.u-tokyo.ac.jp/articles/google-drive/#google-ドライブとは）))
...
* 参考
  * [Googleドキュメントの基本的な使い方](https://utelecon.adm.u-tokyo.ac.jp/articles/google-document/) 
  * 議事録のフォーマット例
