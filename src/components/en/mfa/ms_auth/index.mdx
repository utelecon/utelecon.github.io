...
<ol>
  ...
  <If cond={props.step === "alt"}>
    ...
    <Fragment slot="else">
      ...
      <li>
        ...
        <ArrowOverlay image={firstNext} x={820} y={620} angle={180} />
      </li>
    </Fragment>
  </If>
  ...
  <li>
    ...
    - **Other Devices (PC etc.)**
      1. Click "Next" on <If cond={props.step == "first"}><Fragment>"Now pair Authenticator with your account"</Fragment><Fragment slot="else">"Set up your account"</Fragment></If> screen, and then QR code is shown.
  ...
  <li>
    When <If cond={props.step == "first"}><Fragment>"Authenticator Added"</Fragment><Fragment slot="else">"Notification approved"</Fragment></If> is appeared, click "Next".
