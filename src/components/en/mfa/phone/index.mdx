...
<ol>
  ...
  <li>
    Select the appropriate country code (+81 for Japan) and input your phone number. Also, <If cond={props.step === "alt"}>if you chose "Phone" for the type of phone, </If>choose to either receive a text message with a verification code ("Text a code") or a phone call ("Call").
