...
<div class="box">
    ...
    If you can only see the documents in Japanese, please access [the UTOL's setting page](https://utol.ecc.u-tokyo.ac.jp/common/settings) first, switch the display language, and then access the download page again.
</div>
