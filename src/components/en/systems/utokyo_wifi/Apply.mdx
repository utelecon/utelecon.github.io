...
{/**
  ...
  * @property {string} jouhouSecurity markdown
  */}
...
1. A notification mail with your account information (user ID and password) will be sent to both your [ECCS Cloud Email](/en/eccs_cloud_email) ddress and the email address shown in the "Notification E-mail Address" field.<br />
   ...
   <details>
      ...
      <If cond={props.utasOnly}>
        ...
        <Fragment slot="else">
          ...
          - For faculty members: Log in to [the Personnel Information MyWeb](https://univtokyo.sharepoint.com/sites/utokyoportal/wiki/d/Personal_information_and_ID_card.aspx) and set your "学内メールアドレス" (Campus Email Address) field in the "パーソナルメニュー" (Personal Menu).
...
- <Help lang="en" support={props.support}>
    - **If the following screen appears and you cannot access your account menu:**
      ...
      Your account has been suspended because you have not completed information security education. Please refer to <Markdown content={props.jouhouSecurity} /> for details.
