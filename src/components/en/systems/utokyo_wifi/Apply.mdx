...
1. On the screen that appears, confirm that the email address in the “Notification E-mail Address” field is correct. In doing so, please keep the following points in mind.
   - You can view your UTokyo Wi-Fi account information (user ID and password) both on the account menu screen **immediately after submitting application** (which you will do next) and in the notification email sent after application.
   ...
   - The notification email will be sent to both your [ECCS Cloud Email](/en/google/) address and the email address shown in the "Notification E-mail Address" field.
     <details>
