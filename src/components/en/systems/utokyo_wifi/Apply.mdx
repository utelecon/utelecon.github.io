...
1. On the screen that appears, confirm that the email address in the “Notification E-mail Address” field is correct. For the first time, the "Notification E-mail Address" field is blank.
