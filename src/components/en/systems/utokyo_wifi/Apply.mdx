...
1. On the screen that appears, confirm that the email address in the “Notification E-mail Address” field is correct. For first time applications, the "Notification E-mail Address" field is blank.
   - The user ID and password for your UTokyo Wi-Fi account will be sent to both your [ECCS Cloud Email](/en/google/) address and this "Notification E-mail Address". For first time applications, the user ID and password for your UTokyo Wi-Fi account will be sent to both your [ECCS Cloud Email](/en/google/) address and your contact email address in [UTokyo Account User Information](https://login.adm.u-tokyo.ac.jp/my/).
     <details>
...
1. Click on the "Application" button, confirm the information displayed on the screen immediately afterwards, and write down your user ID and password.
