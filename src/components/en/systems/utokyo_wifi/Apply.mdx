...
1. On the screen that appears, confirm that the email address in the “Notification E-mail Address” field is correct. This field may be blank in some cases. If you can check messages in your ECCS Cloud Email account, please proceed to the next step.
...
<If cond={props.inlineHelp}>
  ...
  <Help lang="en" support={props.support} slot="else">
    - <HelpHaveNoAccess system="the UTokyo Wi-Fi" type="default" />
