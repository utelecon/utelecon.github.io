...
<Help lang="en" support={props.support}>
  - **You cannot access the sign-in screen from the above link**: This occurs when you are already signed in to Microsoft with another account. Click your account picture in the upper-right corner of the [Office 365 home page](https://www.office.com/) (either a picture you set or the default picture that shows your initials or a human silhouette). Click "Sign out" and access the sign-in page again. (If you want to use multiple accounts, please see "[Signing in to Microsoft Systems with Your UTokyo Account > Using Multiple Microsoft Accounts in One Browser](/en/microsoft/signin/#multiple_accounts)".)
