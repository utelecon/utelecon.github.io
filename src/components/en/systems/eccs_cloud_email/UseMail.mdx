...
2. You will be prompted to log in if you have not already done so. Enter the email address you created if you set one yourself; otherwise, enter "10-digit common ID + `@utac.u-tokyo.ac.jp`".
