...
1. Access the [UTokyo Account User Menu](https://utacm.adm.u-tokyo.ac.jp/UserMenu/LoginServlet) and enter the username and password for your UTokyo Account to log in (Please note that the username is only a 10-digit number here).
