...
- <Help lang="en" support={false}>
    - **Error message "Google couldn’t verify this account belongs to you. Try again later or use Account Recovery for help."**:
      ...
      - If changing the environment does not seem to solve the problem, please consult the [Technical Support Desk](/ja/support/) with a note to that effect.
      - For more details, please refer to the ECCS announcement ["An error message of 'Google couldn't verify that this account belongs to you.'"](https://www.ecc.u-tokyo.ac.jp/announcement/2022/09/05_3466.html)
  </Help>
