...
<Support lang="en" show={props.support}>If this procedure does not work, please consult the [support desk](/en/support/). On-site consultations are also available at some computer rooms.</Support>
