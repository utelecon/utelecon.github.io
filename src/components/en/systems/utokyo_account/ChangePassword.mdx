...
export const students = <>You should receive this notification well before classes start; however, if you do not, please contact your faculty/graduate school. (The notification is available to first year undergraduate students entering in April 2024 at the web registration system starting March 21, 2024.)</>
