...
5. Once you successfully log in, press "display information" button.  The page shows your status including Multi-Factor Authentication ("not using it") and Information Security Education ("have not taken").  Proceed to setting up Multi-Factor Authentication and Information Security Education.
