...
2. <If cond={props.variant === "individual"}>
     Please log in to the "UTokyo Account Inital Setup Site" below with the username and password indicated on the notification.
      <b class="box center">
        [UTokyo Account Inital Setup Site](https://login.adm.u-tokyo.ac.jp/utac-initial)
      </b>
      <Fragment slot="else">
        Please log in to the [UTokyo Account Inital Setup Site](https://login.adm.u-tokyo.ac.jp/utac-initial) with the username and password indicated on the notification.
      </Fragment>
   </If>
