...
export const students = <Fragment>You should receive this notification well before classes start; however, if you do not, please contact your faculty/graduate school. (The notification is available to first year undergraduate students entering in April 2024 at the web registration system starting March 21, 2024.)</Fragment>
...
2. <If cond={props.variant === "individual"}>
     Please log in to the "UTokyo Account Initial Setup Menu" below with the username and password indicated on the notification.
      <b class="box center">
        [UTokyo Account Initial Setup Menu](https://login.adm.u-tokyo.ac.jp/utac-initial-en/)
      </b>
      <Fragment slot="else">
        Please log in to the [UTokyo Account Initial Setup Menu](https://login.adm.u-tokyo.ac.jp/utac-initial-en/) with the username and password indicated on the notification.
      </Fragment>
   </If>
