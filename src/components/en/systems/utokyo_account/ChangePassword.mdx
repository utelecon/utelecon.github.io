...
2. <If cond={props.variant === "individual"}>
     Please log in to the "UTokyo Account User Menu" below with the username and password indicated on the notification.
      <b class="box center">
        [UTokyo Account User Menu](https://utacm.adm.u-tokyo.ac.jp/UserMenu/LoginServlet)
      </b>
      <Fragment slot="else">
        Please log in to the [UTokyo Account User Menu](https://utacm.adm.u-tokyo.ac.jp/UserMenu/LoginServlet) with the username and password indicated on the notification.
      </Fragment>
   </If>
