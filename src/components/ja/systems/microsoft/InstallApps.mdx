...
5. インストールが完了した旨が表示されれば完了です．

続いて，<Switch variant={props.variant}><Fragment slot="oc">アプリにサインインしてください．</Fragment><Fragment slot="individual">下の「[アプリにサインインする](#signin)」の手順に進んでください．</Fragment></Switch>
