...
2. <If cond={props.variant === "individual"}>
     以下の「UTokyo Account初期設定メニュー」に，「パスワード通知書」に記載されたユーザ名とパスワードでログインしてください．
     <b class="box center">
       [UTokyo Account初期設定メニュー](https://login.adm.u-tokyo.ac.jp/utac-initial/)
     </b>
     <Fragment slot="else">
       [UTokyo Account初期設定メニュー](https://login.adm.u-tokyo.ac.jp/utac-initial/)に，「パスワード通知書」に記載されたユーザ名とパスワードでログインしてください．
     </Fragment>
   </If>
