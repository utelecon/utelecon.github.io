...
export const students = <Fragment>授業開始に十分間に合うように配布されるはずですが，不明な場合は所属の学部・研究科等に問い合わせてみてください（※2024年4月入学の学部1年生には2024年3月21日からウェブ登録システムで配布されます）．</Fragment>
...
2. <If cond={props.variant === "individual"}>
     以下の「UTokyo Account利用者メニュー」に，「パスワード通知書」に記載されたUTokyo Accountとパスワードでログインしてください．
     <b class="box center">
       [UTokyo Account利用者メニュー](https://utacm.adm.u-tokyo.ac.jp/usermenu/LoginServlet)
     </b>
     <Fragment slot="else">
       [UTokyo Account利用者メニュー](https://utacm.adm.u-tokyo.ac.jp/usermenu/LoginServlet)に，「パスワード通知書」に記載されたユーザ名とパスワードでログインしてください．
     </Fragment>
   </If>
