...
2. <If cond={props.variant === "individual"}>
     以下の「UTokyo Account Inital Setup Site」に，「パスワード通知書」に記載されたUTokyo Accountとパスワードでログインしてください．
     <b class="box center">
       [UTokyo Account Inital Setup Site](https://login.adm.u-tokyo.ac.jp/utac-initial)
     </b>
     <Fragment slot="else">
       「[UTokyo Account Inital Setup Site](https://login.adm.u-tokyo.ac.jp/utac-initial)」に，「パスワード通知書」に記載されたUTokyo Accountとパスワードでログインしてください．
     </Fragment>
   </If>
