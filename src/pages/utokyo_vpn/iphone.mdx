...
<figure class="gallery">
  ![](img/iphone02-setup_home.png){:.border}
  ![](img/iphone03-setup_home_popup_notify.png){:.border}
</figure>
...
<figure class="gallery">
  ![](img/iphone06-home_disconnected.png){:.border}
  ![](img/iphone07-signin_.png){:.border}
</figure>
