...
<figure class="gallery">
  ![](img/ipad02-install.png){:.border}
  ![](img/ipad03-notification.png){:.border}
</figure>
...
<figure class="gallery">
  ![](img/ipad06-home-finished-setting.png){:.border}
  ![](img/ipad07-anyconnect-authentication.png){:.border}
</figure>
