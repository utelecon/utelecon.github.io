...
- 新規にワークスペースを作成するのではなく，現在UTokyo Slack以外でお使いいただいている既存のワークスペースをUTokyo Slackとして利用したい場合のために，以前は編入（移行）という特別な手続きが存在しました．しかし，この手続きは2023年8月で新規の受付を終了したため，今後この手続きを利用することはできなくなりました．
