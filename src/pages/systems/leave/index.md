...
ただし,なんらかの理由で離籍前にバックアップを作成できず，離籍後に正当な理由でどうしてもデータやアカウントへのアクセスが必要になった場合には，いくつかの条件のもとで特例的に，一部のデータやアカウントへのアクセスを提供できる場合があります．詳しくは[「クラウドデータ救出」のページ](./salvage/)を参照してください．なお，この「クラウドデータ救出」のご利用には本人確認サービスの[事前連携](/utokyo_account/ident-myna/#link)が必須となります．万が一の事態に備え，離席前に連携を済ませておかれることをお勧めします．
