...
- **[UTokyo Account](/utokyo_account/)**：東大の情報システムの多くでサインインのために必要となるアカウントです．UTokyo Accountのユーザ名は，「共通ID」と呼ばれる10桁の数字の後ろに @utac.u-tokyo.ac.jp がついたものです．共通IDのみでサインインできる場合もあります．
