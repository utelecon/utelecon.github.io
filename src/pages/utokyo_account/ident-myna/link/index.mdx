...
- 手順3:[UTokyo Accountでサインインして紐付けを行う](#signin)
...
続いて，マイナンバーカードとデジタル認証アプリを用いた本人認証を行います．UTokyo Account本人確認サービスに[スマートフォンのみで認証する場合](#auth-smartphone)と，[PCとスマートフォンを併用して認証する場合](#auth-pc)で手順が少し異なります．それぞれ対応する手順を参照し，作業を進めてください．
