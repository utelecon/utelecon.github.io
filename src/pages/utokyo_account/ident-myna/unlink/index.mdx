...
import InPreparationMyna from "@components/ja/InPreparationMyna.mdx"
...
なおこの手順は，[事前連携の手順1](../link/#app-setup)と同様です．既にデジタル認証アプリのセットアップを済ませたスマートフォンで連携解除を行う場合は，省略し，[手順2](#auth)に進んでください．
