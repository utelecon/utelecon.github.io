...
1. 「上記のひも付けを解除する」ボタンを押して，連携を解除してください．
    ...
    「上記のひも付けを解除する」ボタンではなく「上記のUTokyo Account・連携IDを紐付ける」ボタンが出ている場合，紐付けが行われていない状態だと考えられます．[手順4](#statuscheck)に従って，UTokyo Account利用者情報確認サイト上で連携状況を確認することをおすすめします．
    </details>
...
連携状況はUTokyo Account利用者情報確認サイト上で確認することが出来ます．
...
1. 「UTokyo Account本人確認サービスを利用していません」と表示されていれば，連携解除が完了しています．
