---
title: UTokyo Account本人確認サービスの連携解除について
breadcrumb:
  title: 連携解除
---
...
## はじめに
このページでは，UTokyo Account本人確認サービスを既に利用している方が，「[事前連携](../link/)」を解除する手続きについて説明します．

全体の流れは以下のようになります．

- 手順1:[マイナアプリをセットアップする](#app-setup)
- 手順2:[アプリとマイナンバーカードで本人認証する](#auth)
- 手順3:[ひも付けを解除する](#unlink)
...
なおこの手順は，[事前連携の手順1](../link/#app-setup)と同様です．既にマイナアプリのセットアップを済ませたスマートフォンで連携解除を行う場合は，省略し，[手順2](#auth)に進んでください．
...
1. デジタル庁公式HPに記載されている[マイナアプリの利用登録の方法](https://services.digital.go.jp/auth-and-sign/start-guide/)に従って，マイナアプリの利用登録を済ませてください．
...
<div class="box">
初期設定はまだ完了していません．[手順3](#unlink)に進んでください．
</div>
...
1. 「上記のひも付けを解除する」ボタンを押して，連携を解除してください．
    ![](service_step2_unlink.png){:.border}{:.medium}

    <details>
    <summary>「上記のひも付けを解除する」ボタンが出ない場合</summary>
    「上記のひも付けを解除する」ボタンではなく「上記のUTokyo Account・連携IDをひも付ける」ボタンが出ている場合，ひも付けが行われていない状態だと考えられます．[手順4](#statuscheck)に従って，UTokyo Account利用者情報確認サイト上で連携状況を確認することをおすすめします．
    </details>

    {/* ここから共通 */}
1. 「上記のひも付けを解除する」ボタンが出なくなれば，連携を解除できています．
    ![](service_step2.png){:.border}{:.medium}

## 手順4: 連携状況を確認する
{:#statuscheck}

<CheckStatus variant="unlink"/>
