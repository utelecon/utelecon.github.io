...
- UTokyo Accountは`0123456789@utac.u-tokyo.ac.jp`のように，10桁の共通IDの後に東京大学であることを表す記号@utac.u-tokyo.ac.jpを付けたもので表されます．
...
1. 以下のような「アカウントを回復する」という画面が表示されるので，「メールまたはユーザ名」の欄に「10桁の共通ID＋`@utac.u-tokyo.ac.jp`」を，その下の欄に画像の文字を入力してから「次へ」を押してください．
	...
	システムにメールアドレスが登録されていないため，通知メールを送信することができず，したがってパスワードの再設定ができません．<a href="#reissue-password-service">UTokyo Account 本人確認サービスを利用してパスワードを再発行</a>するか，<a href="#reissue-password">窓口でパスワードを再発行</a>してください．
...
- UTokyo Account 本人確認サービスの事前連携が完了していること．
	- パスワードを忘れてサインインできなくなると、このサービスへの新規登録が行えなくなりますので，ご注意ください．
- 多要素認証で設定している本人確認方法が利用できること．
	- 利用できない場合は，先に[多要素認証の本人確認方法を再登録](mfa/reregister/)してください．その後，一度Microsoftアカウントからサインアウトしてから．以下の手順に進んでください．
- 以下のものがお手元にそろっていること．
...
##### 再発行の手順
1. **[UTokyo Account本人確認サービス](https://identification.adm.u-tokyo.ac.jp/verify/)**{:.box.center}のページにアクセスしてください．
1. 「マイナンバーカードで本人確認」を押して，画面に表示された手順に従って本人確認を完了させてください．
