...
<Fragment slot="problem">ここに掲載されていないシステムについて</Fragment>
<Fragment slot="solution">Microsoftは下記以外のシステムも 提供しており，それらについてUTokyo Accountでサインインして利用できるようになっていることがあります．このようなシステムについて，**継続的な利用を保障することはしていない**ものの，**各自の責任の下**での利用を妨げるような取り扱いはしていません．具体的なリスクとしては，Microsoftによる提供ポリシーの変更により**今まで使えていたシステムが突然使えなくなる**可能性などが考えられます．また，このようなシステムについては**サポート窓口での対応をいたしかねる**場合があります．利用の際はこういったことを十分に念頭に置いてください．もし，教育・研究・業務上の必要性が**特に**高いと思われるシステムについて利用に関する相談をしたい場合，サポート窓口のメールフォームにお越しください．</Fragment>
</HelpItem>
...
**[UTokyo Microsoft LicenseでOfficeアプリを利用する](install)**{:.box.center}
...
Webブラウザ上でOneDrive上にあるファイルを編集することのできるOfficeソフトウェアです．Word，Excel，PowerPointなどが利用できますが，インストールして利用するOfficeアプリと比べると機能は多くありません．
...
利用手順は以下をご覧ください．
**[OneDriveの基本的な使い方](onedrive/basic#ファイルを編集する)**{:.box.center}
...
チャットやビデオ会議などができるビジネスコミュニケーションツールです．利用手順などの説明は以下をご覧ください（教職員のみアクセス可）．
**[東京大学版Microsoft Teams利用者マニュアル](https://univtokyo.sharepoint.com/sites/utokyoportal/wiki/SiteAssets/d/Useful_Tools/%E3%80%8C%E6%9D%B1%E4%BA%AC%E5%A4%A7%E5%AD%A6%E7%89%88_Microsoft_Teams%E5%88%A9%E7%94%A8%E3%83%9E%E3%83%8B%E3%83%A5%E3%82%A2%E3%83%AB%EF%BC%8820210311%EF%BC%89%E3%80%8D.pdf)**{:.box.center}
...
「職員メール」として，`@mail.u-tokyo.ac.jp`のドメインのメールアカウントが提供されています（要申請）．申請方法を含む利用手順などの説明は以下をご覧ください（教職員のみアクセス可）．
**[職員メール](https://univtokyo.sharepoint.com/sites/utokyoportal/wiki/d/Email_system_for_staff.aspx)**{:.box.center}
...
オンラインフォームを作成することのできるシステムです．UTokyo Accountを持つ人限定に公開するフォームを作ることもできます．利用手順などの説明は以下をご覧ください．
**[Microsoft Forms](https://support.microsoft.com/ja-jp/office/620daa7a-3e03-4013-8f92-5cce86210ef6)**{:.box.center}
...
WindowsをEducationエディションにアップグレードするライセンスです．利用手順などの説明は以下をご覧ください．
**[UTokyo Microsoft Windows 10 for students](https://www.u-tokyo.ac.jp/adm/dics/ja/mslicense_win10.html)**{:.box.center}

### 大学所有PC向けMicrosoftライセンス
{:#univ_pc}
大学所有PC（定義：大学が購入し保有し，大学の教職員が管理する共有利用するPC）においては，WindowsをEducation エディションにアップグレードするライセンス，Office Professional Plus 2016（Windows 版），Office for Mac Standard 2019（macOS 版）が利用可能です．
利用手順などの説明は以下をご覧ください（教職員のみアクセス可）．
**[大学所有PC向け Microsoft ライセンス](https://univtokyo.sharepoint.com/sites/utokyoportal/wiki/d/UTokyo_Microsoft_License_for_University_PC.aspx)**{:.box.center}

### UTokyo Microsoft Azure Dev Tools for Teaching
{:#adt4t}
Microsoftの教育機関向けの開発者用ソフトウェアライセンスです．利用手順などの説明は以下をご覧ください．
**[UTokyo Microsoft Azure Dev Tools for Teaching](adt4t)**{:.box.center}
