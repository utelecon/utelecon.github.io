...
1. Microsoft 365ホームの右上にある「インストールなど」をクリックして表示されるメニューで，「Microsoft 365 アプリをインストールする」をクリックしてください．
    <HelpItem lang="ja" type={"details"}>
    <Fragment slot="problem">「Microsoft 365 アプリをインストールする」が表示されない場合</Fragment>
