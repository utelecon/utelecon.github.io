...
<HelpItem lang="ja" type="details">
  <Fragment slot="problem">[Bastion サービス](/research_computing/utokyo_azure/virtualmachine/bastion/) を利用する場合</Fragment>
  <Fragment slot="solution">Bastion サービスを利用してリモートコンソール接続を行う場合は，`なし`を選択してください．</Fragment>
</HelpItem>
<HelpItem lang="ja" type="details">
...
<HelpItem lang="ja" type="details">
  <Fragment slot="problem">[Bastion サービス](/research_computing/utokyo_azure/virtualmachine/bastion/) を利用する場合</Fragment>
  <Fragment slot="solution">Bastion サービスを利用し，かつデータ転送用に外部からの接続を許可する必要が無い場合は，**パブリック受信ポート** は`なし`を設定してください．</Fragment>
</HelpItem>
<HelpItem lang="ja" type="details">
...
<div class="box">
- ストレージは，VMの状態に関わらずストレージサービス自体を停止または削除しない限り常に課金され続けます．ご注意ください．
