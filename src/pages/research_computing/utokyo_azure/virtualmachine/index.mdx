...
**注意**：`Satndard HDD`は 2028 年 9 月に提供が終了される予定で，それまでに`Standard SSD`か`Premium SSD`に移行する必要がある旨 Microsoft Azure からアナウンスされています．当面はまだ利用可能ですが，長期利用を検討されている場合はあらかじめご留意ください．
</div>
