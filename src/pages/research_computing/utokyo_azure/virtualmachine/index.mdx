...
<HelpItem lang="ja" type="details">
  ...
  <Fragment slot="solution"><p>ページ最下部に**マルチテナントをホストする権利を持つ有効な Windows 10/11 ライセンスを所有しています**という項目があるのでチェックを入れてください．UTokyo Azure では [UTokyo Microsoft License](https://utelecon.adm.u-tokyo.ac.jp/microsoft/) で認証されたOSを利用できます．</p><p>また，WindowsOS は必要最小スペックが高めですので、VMサイズを選択する際は Windows 10/11 での最小スペックにご注意ください．特に Windows11 を選択する場合は [Microsoft Learn：Azure 仮想マシンでの Windows 11 のサポート](https://learn.microsoft.com/ja-jp/troubleshoot/azure/virtual-machines/windows/windows-11-support-azure-virtual-machines)を事前に参照ください．</p></Fragment>
</HelpItem>
