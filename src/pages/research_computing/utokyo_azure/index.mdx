...
## 使ってみる
- [Azure Portal](https://portal.azure.com/)には [UTokyo Account](/utokyo_account/) で直ちにログインできます．（[多要素認証](/utokyo_account/mfa/) の設定が必要です）どのようなサービスが使えるかなどは申請前に事前に確認することが出来ます．
