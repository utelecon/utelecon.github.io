...
<p>**重要**：[AI for Science萌芽的挑戦研究創出事業（SPReAD)](https://www.mext.go.jp/aifors_spread/)での利用をご検討されている場合は，Microsoft が提供する SPReAD 向けパッケージのご利用をご検討ください．詳細は以下の資料をご参照下さい．</p>
<p>リンク：[AI for Sciense への Microsoft の取り組み](https://univtokyo.sharepoint.com/:b:/t/Teams.azure.adm/IQAOCz0SZ1dDRakJZZoMvzZtAYqpwaZuhHoM_8HSAkdEFaM?e=TJk4Hf)（要 UTokyo Account）</p>
</font></div>
