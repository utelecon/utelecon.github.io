...
- 定番である各 Linux ディストリビューションをはじめ，[UTokyo Microsoft License](https://utelecon.adm.u-tokyo.ac.jp/microsoft/) によって Windows OS を仮想環境で利用することができます．
...
- 注意）組織アカウントの利用が可能なのは Microsoft Office365 for Copilot になります．Azure for Copilot は対象外なのでご注意ください．
