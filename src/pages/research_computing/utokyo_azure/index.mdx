...
<p>無料分や無料保証枠，自動停止の詳細については以下の資料もご一読ください．<br>
　・[利用料金負担の可能性について](/events/2025-02-21/slides/2_possible_billing.pdf)<br>
　・[サブスクリプションとは](/research_computing/utokyo_azure/faq/subscription/)<br>
