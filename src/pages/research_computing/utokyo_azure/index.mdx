...
<p>無料分や無料保証枠，自動停止の詳細については以下の資料もご一読ください．</p>
<ul><li>[利用料金負担の可能性について](/events/2025-02-21/slides/2_possible_billing.pdf)</li>
<li>[サブスクリプションとは](/research_computing/utokyo_azure/faq/subscription/)</li>
<li>[UTokyo Azure 利用料金規則（学内のみアクセス可）](https://drive.google.com/file/d/129vmaJJmDqkUK0iOMOlkICYMWMw_ZiZL/view)</li>
</ul></div>
