...
<p>**重要**：[AI for Science萌芽的挑戦研究創出事業（SPReAD)](https://www.mext.go.jp/aifors_spread/)での利用をご検討されている場合は，Microsoft が提供する SPReAD 向けパッケージのご利用をご検討ください．詳細は本部研究資金戦略課が SPReAD 希望者向けに配布している資料をご参照ください．</p>
</font></div>
