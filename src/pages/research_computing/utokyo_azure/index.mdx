...
- サブスクリプションができましたら[Azure Portal](https://portal.azure.com/) ([UTokyo Account](/utokyo_account/))へログインして使って下さい．
...
- [Azure 向け Microsoft Learn： 製品説明書を含む総合ドキュメントサイト](https://learn.microsoft.com/ja-jp/training/azure/)
