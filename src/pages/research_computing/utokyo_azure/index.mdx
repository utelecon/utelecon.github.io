...
- 実際に UTokyo Azure の利用を開始するには，あなたの UTokyo Account に紐付いた，本サービス専用の[**サブスクリプション**](/research_computing/utokyo_azure/faq/subscription)を開設する必要があります．そのためにまず[**※12/2 から受け付け開始予定UTokyo Azure新規利用申請ページ（学内アクセス限定）**](http://azure.itc.u-tokyo.ac.jp/)から申請をして下さい．
