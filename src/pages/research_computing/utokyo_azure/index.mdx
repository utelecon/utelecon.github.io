...
- 研究・教育目的で、分野を限定せずに広く利用可能とする
  - 注：事務業務目的でも動作・機能などを検証する目的であれば利用可能です．検証後本格利用に移行する際は全学契約している[Microsoft ライセンス](/microsoft/)を使って下さい．
...
- Microsoft の担当者に問い合わせができます．サブスクリプションやクォータ要求に関する問い合わせはこちらをご利用ください．
