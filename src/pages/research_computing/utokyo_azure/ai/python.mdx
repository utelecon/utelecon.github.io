...
**Microsoft Foundry 以降では，Foundry ポータル上でモデルをデプロイした直後の詳細画面で，PythonでAPIを利用する手順が設定例も含めて詳細に記載されています．本ページの以下の記載も2026年1月現在有効ですが，今後仕様が変更になったり，さらなる詳細が必要な場合は Foundry ポータルの記載をご参照ください．**
