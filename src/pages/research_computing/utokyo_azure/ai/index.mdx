...
### Azure OpenAI
- [Azure OpenAI](/research_computing/utokyo_azure/ai/openai/) は、Microsoft Foundry サービス開始以降 Foundry に統合され，初期手順に少し違いがある以外は最終的に Foundry ポータル上でデプロイして利用する形となるため，OpenAI 利用の場合も通常は Microsoft Foundry からデプロイしてください．
