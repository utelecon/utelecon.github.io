...
- モデルによってデプロイするためには事前登録が必要であったり，必要な入力情報やデプロイ手順が違ったりします．デプロイボタンがグレーアウトしていてデプロイできない場合は，必要条件がそろっているかどうかご確認ください．
- Foundryポータル上部にある`新しいFoundry`スイッチを切り替えると，UIが新しいバージョンに更新されます．このページでは旧バージョン（クラシック版）で説明していますのでご注意ください．新しいバージョンのUIで使う場合は，Microsoft Learn の[Microsoft Foundry（新しい）ポータル]（https://learn.microsoft.com/ja-jp/azure/ai-foundry/what-is-azure-ai-foundry?view=foundry&preserve-view=true）を参照してください．
