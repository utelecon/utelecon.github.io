...
<HelpItem lang="ja" type="details">
  ...
  <Fragment slot="solution">作成されたリソースの利用者になることは問題なく可能です．ただし，無料保証枠を超えた利用があった場合に請求が発生するため，サブスクリプションの申請は教職員に限らせていただいています．作成されたサブスクリプションの共有者として後から権限を付加することは可能です．</Fragment>
</HelpItem>
...
<HelpItem lang="ja" type="details">
  ...
  <Fragment slot="solution">一定額として決めておらず，全体で申請されたサブスクリプション数によって動的に変動します．UTokyo Azure 新規申請ページの管理ページから金額を確認することができます．</Fragment>
</HelpItem>

<HelpItem lang="ja" type="details">
  <Fragment slot="problem">最初に割り当てられた無料保証枠は確定で使えますか</Fragment>
  <Fragment slot="solution">全体で申請されたサブスクリプション数に応じて，利用開始後に減額されます．毎月1回再計算が行われ，その時点での金額はUTokyo Azure 新規申請ページの管理ページから確認することができます．</Fragment>
</HelpItem>
