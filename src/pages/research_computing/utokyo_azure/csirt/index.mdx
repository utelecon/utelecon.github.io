...
UTokyo Azure は商用クラウドサービスである Microsoft Azure の資源を利用したサービスのため，その責任分解点は主に IaaS であるか SaaS であるかの２通りで分類されます。
- サービスの提供形式により，必ずしもこの形に収まらない場合があります．実際のインシデントが発生した場合は UTokyo Azure CSIRT が発生元のリソース等からどちらの責任分かを判断します．
