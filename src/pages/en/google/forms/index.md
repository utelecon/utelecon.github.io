...
This section introduces how to use Google Forms as a survey form. Please note that [UTOL](/en/utol/lecturers/surveys/) also offers similar features for conducting surveys within a class.
...
When instructors use a survey form as a class attendance form, please note that [UTOL](/en/utol/lecturers/attendances/) also provides similar capabilities. The respective advantages of Google Forms and UTOL are as follows:
...
This is intended for instructors to check students' understanding of the lecture. As with the class attendance forms, [UTOL](/en/utol/lecturers/quizzes/) also offers similar features.
...
A form consists of any number of questions. The following explains how to create questions. Please also refer to "[Edit your Form](https://support.google.com/docs/answer/2839737?hl=en)" (official help) as needed.
...
This section explains how to publish a completed form so that others can respond, and how to share it for collaborative editing. Please also refer to "[Publish & share your form with responders](https://support.google.com/docs/answer/2839588?hl=en)" (official help).
...
Additionally, when sharing forms that collect sensitive information such as personal data, be aware that using the "[Show a summary of responses](https://support.google.com/docs/answer/2839588?hl=en)" (official help) feature may lead to information leaks.

You can change the scope of users who can respond to the form by clicking the respective buttons for editors and respondents that display permission levels, such as "Restricted" or "東京大学ECCSクラウドメール" (Japanese name for "The University of Tokyo ECCS Cloud Email").
...
* Copying and sharing the URL from the browser toolbar: You must first allow the editor view for "Anyone with the link" or "東京大学ECCSクラウドメール" (Japanese name for "The University of Tokyo ECCS Cloud Email") in the editor selection screen.
...
![](./linking-spreadsheet.jpg){:.medium}
...
For more details, refer to "[Choose where to save form responses](https://support.google.com/docs/answer/2917686?hl=en)" (official help).
...
There are two main possible causes. Please also refer to "[Get permission to open a Google Form](https://support.google.com/docs/answer/160166?hl=en)" (official help) for more details.
...
![Features accessible via the icons on the right or bottom of the questions editing screen](./editing-form.jpg)
...
![About the "Required" toggle and the ellipsis next to it at the bottom of the question editing screen](./editing-question.jpg)
...
2. Go to Section
   * For questions with a selection-based format (Multiple choice, Dropdown), the "Go to section based on answer" button lets you set which section respondents are directed to depending on their answer.
   ...
   * For detailed setup instructions, refer to "[Show questions based on answers](https://support.google.com/docs/answer/141062?hl=en)" (official help).
...
5. Add Images
   ...
   * When you insert images, the respondent view will look like this: images added next to the question text appear below the question, while images added next to an option appear above that option.
...
1. Use as a Test
   ...
   * For more information, please refer to the following resources as needed.
      * [Create & grade quizzes with Google Forms](https://support.google.com/docs/answer/7032287?hl=en) (official help)
...
9. Auto-save Responses
   ...
   * For more details, please refer to [Autosave your response progress on a Google Form](https://support.google.com/docs/answer/10952360?hl=en) (official help).
