...
1. The meeting URL (`https://meet.google.com/xxx-xxxx-xxx`) will be displayed as "Here's your joining info". Copy and share it with the participants.
...
1. Click the desired time slot for the meeting on the calendar.
...
1. Receive the meeting URL from the organizer (via UTOL, email, Google Calendar, etc.).
