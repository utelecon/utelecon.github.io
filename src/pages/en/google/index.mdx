...
### Task: Set your password and email address
{:#configure}

\* Even if you are already using ECCS Cloud Email, you can change your password and email address by following this procedure as in the initial setup.

<ECCSCloudEmailConfigure img inlineHelp waitForReflection />

After setting your password and email address, it will take **up to about 40 minutes** to take effect, so **please wait a while until you are able to log in**.
