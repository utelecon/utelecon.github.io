...
- The “profile name” of your ECCS Cloud Email account (shown as “Name” on the screen) is automatically created via system synchronization, but you can change it yourself.
...
1. In your browser, [log in to ECCS Cloud Email](../../#login).
