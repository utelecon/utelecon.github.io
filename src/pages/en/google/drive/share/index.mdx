...
1. On the right side, you will see a section labeled “Editor”, which is where you can set the access permissions for the individual. Click this section to set the access permission parameters. For details on the available types of access permissions, refer to “[Types of Access Permission](#access-level)”.
...
1. A menu for selecting the access permission parameters will be displayed. Adjust the permissions as needed. For details on the types of access permissions available, refer to “[Types of Access Permission](#access-level)”.
...
- Access: “Allow editors to change permissions and share”
...
- People who can download, copy, and print: “Editors” "Commenters and viewers"
    - When the checkbox is on (default), those with “Editors” or “Commenters and viewers” access can download, print, and copy the file. Turning it off will prohibit these actions.
