...
Additionally, please refer to “[Recommended Method for Sharing Files on Google Drive](../recommendation/)”, which explains the recommended methods for sharing files according to different cases, and the page “[Proposal for a New File Sharing Policy Using Cloud Storage (in Japanese)](/articles/share-policy/)”, which explains ways to enhance productivity and security when sharing files.
...
1. On the right side, you will see a section labeled “Editor”, which is where you can set the access permissions for the individual. Click this section to set the access permission parameters. For details on the available types of access permissions, refer to “[Access Permissions Details](#access-level)”.
