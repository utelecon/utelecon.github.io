...
Alternatively, you can set a “Numbered list” using the shortcut keys “Ctrl + Shift + 7” on Windows, or “⌘ + Shift + 7” on Mac.
![](docs11.png)

#### Bulleted lists
Select the text you want to write in bullet points, and select the “Bulleted list” icon on the toolbar.

Alternatively, you can set a “Bulleted list” using the shortcut keys “Ctrl + Shift + 8” on Windows, or “⌘ + Shift + 8” on Mac.
![](docs12.png)
...
Also, as shown below, you can change the hierarchical level using the indent options as well.
![](docs14.png)
