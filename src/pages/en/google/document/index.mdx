...
There are two ways to share documents: “sharing with specific individuals” and “sharing with unspecified groups of people”. Clicking the “Share” button in the upper right of the editing screen opens the same settings screen as [the sharing procedure in Google Drive (in Japanese)](../drive/share/#procedure). Please configure your sharing settings by following the instructions in “[Settings procedure for sharing with specific individuals (in Japanese)](../drive/share/#individual)” or “[Settings procedure for sharing with unspecified groups of people (in Japanese)](../drive/share/#procedure-unspecified)”.
