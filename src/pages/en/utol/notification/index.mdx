...
5. After joining Slack, the workspace screen will appear. Open the drop-down list that shows the workspace name in the top left and confirm that "UTOL通知" appears in the list of workspaces.
