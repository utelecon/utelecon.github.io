...
This page explains how to use UTOL as a student enrolled at UTokyo. For instructions on how to use UTOL as a faculty member or TA, please refer to the “[Using UTOL as a Faculty Member or TA](../lecturers/)”.
...
## Checking the courses you are registered for
{:#courses}
...
For more information, please refer to “[Registering courses through UTOL (for enrolled students)](course_registration/)”.
...
1. Click the "Not Submitted" (or "No Submission Required") button in the "Submission status list" column.
...
### List of Notifications or Updates
{:#notification}
...
For details, please refer to [“Searching courses in UTOL (for enrolled students)](course_search/)”.
...
- [Registering courses in UTOL (for enrolled students)](course_registration/)
- [Searching courses in UTOL (for enrolled students)](course_search/)
