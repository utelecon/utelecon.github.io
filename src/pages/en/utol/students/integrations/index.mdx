...
UTOL has a function that allows you to link external tools such as Slack or Zoom. When you use this function for classes, please refer to the steps in the "How to use external tools" section, as the usage differs depending on the service.
