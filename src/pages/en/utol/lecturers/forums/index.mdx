...
- Since everything is done on UTOL, all students can use it without special settings.
  - There is no need to invite enrolled students to other tools (such as [UTokyo Slack](/en/slack/)) or for students to register for the tool.
- You can use the [markup function](../../markup/) to post messages containing mathematical formulas and links.
- It is also possible to set up certain forums to be open only to some enrolled students, for example, when using them for discussions in group work.
...
- **Threads**: This is the framework for each theme that can be created for a theme. Multiple threads can be registered for a single theme. A "Default thread" is generated when a new theme is registered.
...
## How to Operate Themes
{:#theme}

### Registering Themes
{:#register-theme}

Authority for Operation: Course Instructor, Course Designers, and TAs
...
When you register a new theme, a thread with the title "Default Thread" is automatically generated. You can [edit the thread](#edit-delete-thread) as needed to clearly indicate its purpose by setting an appropriate title and description.

### Editing and Deleting Themes

Authority for Operation: Course Instructor, Course Designers, and TAs

To edit, open the Course Top screen and click on the "Theme Title" (blue link) on the Forums. This will take you to the Editing Theme screen.
![](course-top-theme.png)

To delete, click the ![︙](../../_icons/control_btn_icon.png){:.icon} icon on the right side of the "Forums" of the Course Top screen, then select "Delete".
...
Authority for Operation: Course Instructors, Course Designers, TAs, and Enrolled Students

1. Open the Course Top screen and scroll down to the "Forums" section.
2. In the "Forums" section, click the ![︙](../../_icons/control_btn_icon.png){:.icon} icon to the right of the theme for which you want to register a thread.
...
Authority for Operation: Course Instructors, Course Designers, TAs, and Enrolled Students<br/>
\* However, enrolled students can only delete threads they have created by themselves and that have no messages posted.

1. Open the Course Top screen and scroll to the "Forums" section.
2. In the "Forums" section, click the ![︙](../../_icons/control_btn_icon.png){:.icon} icon on the right side of the theme to which the thread you want to edit or delete belongs.
   ![](course-top-operation.png)
3. Click "Join".
   ![](join-theme.png){:.extra-small}
...
- [**Downloading Posts by Thread**](#download-thread-messages): This function allows you to download messages by thread as a zip file containing an Excel file (`.xlsx`) and an HTML file. It is available to course instructors, TAs, and enrolled students only during the posting period.
...
Authority for Operation: Course Instructors

1. Open the Course Top screen and scroll to the "Forums" section.
2. In the "Forums" section, click the ![︙](../../_icons/control_btn_icon.png){:.icon} icon to the right of the theme you want to batch download posts.
   ![](course-top-operation.png)
3. Select "Join".
   ![](join-theme.png){:.extra-small}
...
Authority for Operation: Course Instructors, TAs, and Enrolled Students

1. Open the Course Top screen and scroll to the "Forums" section.
2. In the "Forums" section, click the ![︙](../../_icons/control_btn_icon.png){:.icon} icon to the right of the theme whose thread you want to download posts from.
   ![](course-top-operation.png)
3. Select "Join".
   ![](join-theme.png){:.extra-small}
...
1. Open the Course Top screen and scroll to the "Forums" section.
2. In the "Forums" section, click the ![︙](../../_icons/control_btn_icon.png){:.icon} icon to the right of the theme whose thread you want to post a new message.
   ![](course-top-operation.png)
3. Select "Join".
   ![](join-theme.png){:.extra-small}
4. Click the thread title (blue link).
...
Authority for Operation: Course Instructors, TAs, and Enrolled Students<br/>
\* However, students can only edit or delete messages that they have posted themselves.

1. Open the Course Top screen and scroll to the "Forums" section.
2. In the "Forums" section, click the ![︙](../../_icons/control_btn_icon.png){:.icon} icon to the right of the theme whose thread you want to edit or delete a message.
   ![](course-top-operation.png)
3. Select "Join".
   ![](join-theme.png){:.extra-small}
4. Click the thread title (blue link).
...
Authority for Operation: Course Instructors, and TAs

1. Open the Course Top screen and scroll to the "Forums" section.
2. In the "Forums" section, click the ![︙](../../_icons/control_btn_icon.png){:.icon} icon to the right of the theme whose thread you want to check viewing status.
   ![](course-top-operation.png)
3. Select "Join".
   ![](join-theme.png){:.extra-small}
4. Click the ![︙](../../_icons/control_btn_icon.png){:.icon} icon on the right side of the Thread List.
