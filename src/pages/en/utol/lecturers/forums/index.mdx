...
2. Enter the following information on the Register theme screen.
   ...
   - **Published target** \[Required\]
     - You can select the target for the registered topic from "All Enrolled Students", "Select User group", or "Select Enrollment".
...
2. In the "Forums" section, click the ![︙](../../_icons/control_btn_icon.png){:.icon} icon on the right side of the topic to which the thread you want to edit or delete belongs.
   ![](course-top-operation.png)
3. Click "Join".
   ![](join-theme.png){:.extra-small}
...
2. In the "Forums" section, click the ![︙](../../_icons/control_btn_icon.png){:.icon} icon on the right side of the topic to which the thread you want to view belongs.
   ![](course-top-operation.png)
3. Click "Join".
   ![](join-theme.png){:.extra-small}
...
1. Open the Course Top screen and scroll to the "Forums" section.
2. In the "Forums" section, click the ![︙](../../_icons/control_btn_icon.png){:.icon} icon to the right of the theme you want to register a thread for.
   ![](course-top-operation.png)
3. Select "Join".
   ![](join-theme.png){:.extra-small}
