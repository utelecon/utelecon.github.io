---
title: Using the Forums on UTOL (for Course Instructors / TAs)
breadcrumb:
  title: Forums
---
...
Permissions: Course Instructors, Course Designers, and TAs
...
1. Open the Course Top screen and scroll to the "Forums" section.
2. In the "Forums" section, click the ![︙](../../_icons/control_btn_icon.png){:.icon} icon to the right of the theme containing the message you want to edit or delete.
   ![](course-top-operation.png)
3. Select "Join".
   ![](join-theme.png){:.extra-small}
4. Click the thread title (blue link).
