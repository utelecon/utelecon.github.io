...
UTOL course participants (instructors, TAs, and enrolled students) can send messages to one another. The message function is useful for communication, both inside and outside of class, allowing students to ask instructors questions or exchange messages during group work.
...
Notifications for messages from students, as well as replies from other instructors or TAs, can be received via email or LINE. For details, please refer to "[Settings in UTOL to receive notifications](../../notification/)".
...
2.  Enter the required information in the Send Message screen shown in the image below. Please note that clicking the "Update" button before sending may cause the entered information to be lost.
    ...
    * Address: Specify the addresses for course instructors / TAs (course administrators) and students separately, depending on whom you intend to send the message.
      ...
      * Specify the student addresses.
        * Select students by checking the checkbox on the left side of the Address list. Checking the top checkbox can select all students.
...
1. Check the Message section on the Course Top screen.
    ...
    - Clicking the "Messages in this course" displays a list of messages that you have either sent or received.
2. Clicking a message title you want to view opens the message screen.
    ...
    ![Message screen](message_send_back.png)
...
4.  A confirmation screen will appear. In the "Message Usage", confirm that it is checked in the checkbox of "Messages are exchanged among faculty, TAs, and students" if you want to enable it, or it is not checked in the checkbox if you want to disable it. Then click "Register" at the bottom of the page.
