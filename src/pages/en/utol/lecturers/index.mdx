...
### About the Screen for viewing and the Screen for editing
{:#view-edit-mode}
In UTOL, course instructors and TAs can switch between the "Screen for viewing" and the "Screen for editing" when managing their courses. Please switch these modes using the menu in the top left of the "Course Top" screen.

- **Screen for viewing**: This mode is for checking how students see the site. It is useful when you want to see in advance how information notices, course materials, and assignments appear to enrolled students.
- **Screen for editing**: This mode is for various editing and course settings, such as creating information notices, setting up assignments, and managing course participants. This is also the default screen for course instructors and TAs when opening a course from the Timetable screen.
...
**[Request form to Create Courses](https://forms.office.com/Pages/ResponsePage.aspx?id=T6978HAr10eaAgh1yvlMhAV1xFVIiWBKstSDeuZIIuFUMk1RVDFDVU1GOVJMU1BHS0RXNDYxTFpGNSQlQCN0PWcu)**{:.box.center}
