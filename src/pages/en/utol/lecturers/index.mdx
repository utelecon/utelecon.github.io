...
The forum function enables the exchange of opinions through text messages between you and the enrolled students, as well as among the enrolled students. Unlike the [Message function](#messages), which allows only enrolled students you are exchanging to be able to view messages, the forum function enables to make messages to open all enrolled students. Please refer to “**[Using forum function in UTOL (for Course Instructors / TAs)](forums/)**” for more details on how to use the function.
