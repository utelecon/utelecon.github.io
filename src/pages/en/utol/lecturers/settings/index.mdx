...
This page explains settings related to the entire course in UTOL, including course summary and participant management.
...
Please note that TAs have limited access to the settings explained in this page. They can only manage labels, update online class information, and view the “Register Course participants” screen. They cannot perform other functions, such as adding or removing course participants.
...
You can also use markup in this setting. For details on using markup, refer to “[Markup](../../markup/).”
...
- Zoomを利用する場合は，アプリから参加する学生のため，URLだけでなく，ミーティングID，パスコード等も記入してください．
- When using Zoom, include not only the URL but also the meeting ID and passcode for students joining from the app, .
...
You can configure message function and attendance display settings using “Course Settings > Course Settings.”[^1]
...
- **Message Usage**
  - Enabling “Messages are exchanged among faculty, TAs, and students” allows message function.
...
- **Automatically registered attendance information**
  ...
  - Enabling “Display attendance information automatically registered from Classes management to enrolled student” shows automatically set attendance informations to students.
