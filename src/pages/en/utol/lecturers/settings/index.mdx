...
You can also use markup in this setting. For details on using markup, please refer to “[Markup](../../markup/).”
...
For details, please refer to “[User Groups](user_groups/).”
...
It is important to be cautious when using labels, as they are visible to both instructors and students, including those who have no applicable content. Avoid including sensitive information in labels.
...
There are two ways to set labels for content: during creation or afterward. Here, we will explain how to do it afterward.
...
If you want to link a different label than the current one, first unlink it and then re-link it to the new label. Dragging and dropping from one label to another will not reflect the change.
...
You can configure messaging function and attendance display settings using “Course Settings > Course Settings.”[^1]
...
- **Message Usage**
  - Enabling “Messages are exchanged among faculty, TAs, and students” allows messaging function.
...
- **Automatically registered attendance information**
  ...
  - For detailed information on class sessions and attendance, please refer to “[Attendance](../attendances/).”
