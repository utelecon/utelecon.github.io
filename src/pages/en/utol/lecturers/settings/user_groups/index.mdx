...
{:#about}
In the courses on [UTOL](/utol/), you can create units called “user groups” from among the students taking the course. These are used to make course contents (such as [course materials](/utol/lecturers/materials/) and [assignments](../../assignments/)) available only to certain students, allowing you to choose to make the contents available only to certain user groups.
...
1. Click "User group settings" under "Course settings".
    <details>
    <summary>If there are no "Course settings"</summary>
         You may not have <a href=#details>the authority required to change registered user groups</a>. If you consider it necessary, please consult the course instructor about <a href=/utol/lecturers/settings/course_participants/>granting the authority</a>.
    </details>
...
1. Click "User group settings" under "Course settings".
    <details>
    <summary>If there are no "Course settings"</summary>
         You may not have <a href=#details>the authority required to delete user groups</a>. If you consider it necessary, please consult the course instructor about <a href=/utol/lecturers/settings/course_participants/>granting the authority</a>.
    </details>
