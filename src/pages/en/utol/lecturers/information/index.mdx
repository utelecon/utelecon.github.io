...
1. For the assignment you wish to register as a reminder notice, click the ![≡](../../_icons/control_btn_icon.png){:.icon} mark in the “Action” field in the “Assignment” section of the Course Top screen, and then click the “Register Reminder Information” from the menu displayed on the screen.
