...
This page explains how to view aggregated results and how to add comments to responses. It also describes how to check the overall response status for all the surveys within a course.
...
The method for checking survey responses differs depending on whether the survey is anonymous or non-anonymous:

- Anonymous surveys: Responses can be checked by [batch downloading them](#answer-download).
- Non-anonymous surveys: Responses can be checked [individually on UTOL](#answer-comment) or by [batch downloading them](#answer-download).

In addition, for non-anonymous surveys, you can add comments to individual responses or to all responses at once.

### Viewing responses and adding comments on UTOL
{:#answer-comment}

You can view individual responses and add comments on UTOL for non-anonymous surveys.
...
1. A table showing each response will appear. Click the link in the “Feedback Comment” column on the right.
    - If no comment has been added yet, it will say “Add Comment”.
    - If a comment has already been added, the date and time when the comment was posted will be shown.
    ![](./open-answer.png){:.medium}

1. Each response to the questions will be displayed.
    ![](./view-answer.png){:.small}

1. To register a feedback comment, enter your comment in the “Feedback Comment” field and click “Register”.

### Downloading responses in batch
{:#answer-download}

Aggregated results can be downloaded in the following way (applies to both anonymous and non-anonymous surveys).

1. Click the ![︙](../../_icons/control_btn_icon.png){:.icon} next to the survey you want to download responses from and click "Check Response".

1. Click "Download" in the "Download Result" section.
...
1. Click "Download" to download a zip.
...
You can add comments in batch to responses from non-anonymous surveys.
Please note that comments cannot be added to anonymous survey responses.

1. Click the ![︙](../../_icons/control_btn_icon.png){:.icon} next to the survey you want to comment on, then click "Check Response".
...
1. Open the downloaded Excel file, enter your comments in the "Comment" column, then save the file.
...
1. If the upload is successful, the message "Upload completed" will appear.
...
**Note**: When the "Enrolled student range settings" is set to "Always ‘Registration and Instructor registration only’", enrolled students who have been added through self-registration or other methods will not be able to access course contents, including surveys. In addition, for non-anonymous surveys, even if such students were able to submit responses under previous range settings, their responses will not be included in the aggregated results if they currently cannot access the content.
...
1. Click the ![︙](../../_icons/control_btn_icon.png){:.icon} next to the survey you want to comment on, then select “Comment”.

1. Enter the comments, then click “Register”.

## Viewing response status to a survey

You can view the overall response status of participants by clicking “Check submission of all enrolled students” in the “Survey” section on the course top page.

In addition, by clicking on a student’s student number (or common ID) in the “Check submission of all enrolled students” screen, you can view the response status of that individual student.

Please note that anonymous surveys are not shown in the "Check submission of all enrolled students” screen and individual responses to such surveys cannot be viewed.
