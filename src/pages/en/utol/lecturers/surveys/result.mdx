...
This page explains how to view aggregate survey results and add comments to survey responses. It also describes how to check the overall response status for all the surveys within a course.
