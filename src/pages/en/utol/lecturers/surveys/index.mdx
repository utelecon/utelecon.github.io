...
[Create and Edit Surveys] (https://utelecon.adm.u-tokyo.ac.jp/en/utol/lecturers/surveys/create/）

### Viewing Aggregated Results
Please refer to the following page for instructions on how to view the aggregated results.

[View Aggregated Results] (https://utelecon.adm.u-tokyo.ac.jp/en/utol/lecturers/surveys/result/）
