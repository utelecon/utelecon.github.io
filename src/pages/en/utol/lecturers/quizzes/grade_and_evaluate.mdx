---
title: Scoring quizzes and checking answer status (for Course Instructors / TAs)
breadcrumb:
...
For information on how to create and edit quizzes, please refer to "[Creating and editing](https://utelecon.adm.u-tokyo.ac.jp/utol/lecturers/quizzes/create) quizzes", and for an explanation of the test function in general, please refer to **"**[Using the quiz function](https://utelecon.adm.u-tokyo.ac.jp/utol/lecturers/quizzes/)"**.**
...
-   Variations in notation (e.g., "notebook" and "NotePC")
...
To check the students\' test answers, please follow the procedure below.

1\. Click on "Check answer status" in the "︙" button on the right of the "Quizzes" column on the "Course Top" screen.
...
-   [Scoring on UTOL](https://utelecon.adm.u-tokyo.ac.jp/utol/lecturers/quizzes/grade_and_evaluate#grade_on_utol)

-   [Downloading the Excel file for scoring and uploading it after scoring](https://utelecon.adm.u-tokyo.ac.jp/utol/lecturers/quizzes/grade_and_evaluate#grade_on_excel)
...
1.  On the "Check Answer" screen, click on "Score and Comment \[scoring incomplete\]" for the answer you want to score.

\[Insert #3 image\]

If the answer has already been scored, "\[scoring incomplete\]" will not be displayed, but you can still score it again in the same way.
...
3\. After scoring the answers, click "Register" at the bottom of the screen. Even if the scores for all the questions that are not automatically scored are 0, you can still score them by clicking this button.
...
1.  Download the necessary files from the \"Check Answers\" screen. There are two files you can download.
...
The first can be downloaded from \"Format Download\", and the second can be downloaded from \"Download\" in \"Download an Answer\".
...
3\. Once you have finished entering the scoring results, click \"Reference\" on the \"Check Answers\" screen, select the Excel file for scoring, and then click \"Upload\" to upload the file.

-   It is okay if you do not have entered scoring results for all the rows.
...
4\. If the file is uploaded successfully, the scores and feedback comments in the Excel file for scoring will be loaded, and the status column for the targeted student in the \"Answer Status\" screen will change to \"Scored\" or \"Entered by the instructor\".
