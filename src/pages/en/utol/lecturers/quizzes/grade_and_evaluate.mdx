...
4. If the file is uploaded successfully, the scores and feedback comments in the Excel file for scoring will be loaded, and the status column for the scored students in the “Answer Status” screen will change to “Scored” or “Entered by the instructor”.
