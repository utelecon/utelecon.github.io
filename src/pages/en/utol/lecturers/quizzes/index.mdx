...
**[Creating and editing quizzes in UTOL (for Course Instructors / TAs)](create/)**{:.box.center}
...
**[Scoring quizzes and checking answer status (for Course Instructors / TAs)](grade_and_evaluate/)**{:.box.center}
