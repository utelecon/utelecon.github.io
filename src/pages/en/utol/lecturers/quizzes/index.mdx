...
Based on the content you intend to test, you can create a quiz by combining four formats: single-selection, multiple-selection, free-text (free description), and fill-in-the-blanks. Automatic scoring is available for all formats except for the free-text format.
