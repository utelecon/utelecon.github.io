...
1. First, decide the format of the question you want to create. Please choose the appropriate one from the following four types according to the content you want to ask about.
    ...
    -   **Single-selection format** (Single Choice): A question where the student chooses one answer from the options. Automatic scoring is possible.
    -   **Multiple-selection format** (Multiple Choice): A question where the student chooses multiple answers from the options. Automatic scoring is possible.
