---
title: Creating and editing quizzes in UTOL (for Course Instructors / TAs)
breadcrumb:
...
Please refer to "Scoring quizzes and checking answer status" for information on scoring quizzes and checking submission status.
...
To create a new quiz, click on the "+" button in the "Test" section of the "Course Top" screen. The "Create a New Quiz" screen will appear.
...
First, please enter the setting items for the entire quiz. You can edit the settings even after they have been completed, but depending on the timing, the items that can be edited may be limited. For details, please refer to "[Editing a created](https://utelecon.adm.u-tokyo.ac.jp/utol/lecturers/quizzes/create#update) quiz" at the bottom of this page.
...
-   **Contents\***: A quiz description (supports the [markup function](https://utelecon.adm.u-tokyo.ac.jp/utol/markup/))
...
-   **Random Quizzes\***: It allows you the option to randomly generate or not questions that differ depending on the student.
    ...
    -   If you want to ensure that a question is always included in the test, regardless of the students, you can make it a required question. For information on how to specify a required question, please refer to the end of [Procedure 2](https://utelecon.adm.u-tokyo.ac.jp/utol/lecturers/quizzes/create#create_problem).
...
<!-- -->
```
-   **Display label**: Labels can be added for categorization purposes.

```{=html}
<!-- -->
```
-   Once labels have been added, a drop-down list like the one below will appear on the "Course Top" screen, allowing students and instructors to display content by label.

\[Insert #4 image\]

-   To add labels, select the label you want to add from the drop-down list.

    -   If you have not created labels, click on "Create New Display Label" and enter a label name.

    -   If you want to add multiple labels, select them from the separate drop-down list that appears when you click "Add display label".
...
-   By specifying user groups or students, you can restrict the test to only specific students in the course.

### Procedure 2: Creating a New Question
{:#create_problem}

Click on \"Create New\" in the \"Create a New Question\" section at the bottom of the \"Quiz Registration\" screen. The \"Register for Questions\" screen will then appear.
...
-   **Contents\***: A question description (supports the [markup function](https://utelecon.adm.u-tokyo.ac.jp/utol/markup/))
...
-   **Correct Answer\***：(only the Fill-in-the-blank format・Free-text format）Correct answer
...
4\. After you have finished setting up the entire test and creating the questions, click on "Confirm" at the bottom of the "Quiz Registration" screen to check the contents, and then click on "Register" to register for the test.

You can also reorder the questions you have created and edit them again on the \"Quiz Registration" screen of the test.

If you set the test to use "Random Quizzes" in Procedure 1, you can specify the required questions on the "Quiz Registration" screen. Please check the box at the upper right corner of the question you want to make required.
...
1\. Click on the "Simulation" button on either the \"Test Registration\" screen or the \"Test Editing\" screen.
...
４． After answering the questions, click on "Confirm" to move to the \"Test Check Answer\" screen.

５． Check your answers and click "Submit" to send them. The "Test Answer Result" screen will be displayed.

６．Finally, click "Back". You will be taken back to the \"Test Registration\" screen or the \"Test Editing\" screen\".

If any problems are found in the test simulation, to fix the test, please refer to the section below on "[Editing the Test You Have Created](https://utelecon.adm.u-tokyo.ac.jp/utol/lecturers/quizzes/create#update)".

## Editing the test you have created
{:#update}

To edit a test you have already created, click on the title of the test title you want to edit in the "Quizzes" section of the "Course Top" screen. The "Edit Test" screen will look the same as the screen you see when you first register for a test.

### Editing the settings for the entire test

You can edit the settings for the entire test. For an explanation of each setting item, please refer to "[Procedure 1: Settings for the entire test](https://utelecon.adm.u-tokyo.ac.jp/utol/lecturers/quizzes/create#general_settings)" in "Creating a new quiz".
...
You can edit each question in the test. To edit a question, click on the pencil icon at the top right corner. To explain each question item, please refer to Procedure 2: Creating a New Question in "Creating a New Quiz".
...
2.  When the "Editing" screen appears, click "Register template" in the "︙" mark on the left of the "Create a New Question\" column.

\[Insert #8 image\]

3\. When the "Template Registration Confirmation" screen appears, check that the template details you are registering are correct, then click "Register".

Please note that the template title will be registered with the same name as the test title. Although it is possible to have duplicate titles between templates, to prevent confusion,

we recommend changing the title to something easy to distinguish, following the instructions in the next section, "Editing and deleting quiz templates" .

### Editing and deleting quiz templates

To edit and delete quiz templates, please follow the procedure below.

1\. On the "Course Top" screen, click the \"Edit template\" in the "Quizzes" column. The \"Quiz Templates\" screen will appear.

\[Insert #9 image\]

2\. Click on the title of the template that you wish to edit or delete.

-   To edit a template: Please edit the displayed settings. You can only edit the template title and questions. Other items displayed on the "New Registration" and "Editing" screens cannot be edited as they are not included in the template.
...
1.  On the "Course Top" screen, click on "Edit template" in the "Quizzes" column. The \"Quiz Templates\" screen will appear.

2.  For templates created by other users, "Register" will be displayed. Click "Register" for the template you want to take over.

3.  The "Quiz Template Registration/Editing" screen will be displayed. Make any necessary changes, such as changing the title to something more descriptive, and then click "Confirmation".
