...
* The same workspace cannot be used for the other courses. For example, even if the same course is offered in the following year, a new workspace must be created and linked to the new course for that year.
...
3. Please apply to use the Slack Integration feature by filling in the required information in the "[\[UTOL\] Application Form for Slack Integration](https://forms.office.com/pages/responsepage.aspx?id=T6978HAr10eaAgh1yvlMhAV1xFVIiWBKstSDeuZIIuFUQVNXSzlSUEk5VEpOU1dGV0pUNjA3RVBZVSQlQCN0PWcu&route=shorturl)".
   ...
   * Only the course instructor(s) of the relevant courses can apply. Students, including TAs, etc. are not allowed to apply.
...
* The user that created the workspace becomes the workspace "owner" and will be treated as a "[representative](/en/slack/workspace/#overview-and-preactions)" who is responsible for the management and operation for the workspace.
...
* A special member - "UTokyo Slack Primary Owner" (account type: primary workspace owner) - is included in the workspace in addition to course participants. The UTokyo Slack Primary Owner can not be removed.
