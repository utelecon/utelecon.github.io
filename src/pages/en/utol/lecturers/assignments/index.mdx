...
2. When the "Assignment Confirmation of overall submission status" screen opens, please proceed according to the following two methods of checking.
   - [Checking All Enrolled Students](#submission-status-all-user)
   - [履修者ごとに確認する](#submission-status-per-user)

### Checking All Enrolled Students
...
- "Feedback Comments"
  ...
  - "Comment"
    - This is detail feedback on an assignment.
...
3. Place the feedback file in the "Feedback" folder located in the extracted folder and enter the file name in the "File name" field of the Excel file.
   - e.g.: If the feedback file is for enrolled student A, it will be "`Feedback_A.pdf`". Place "`Feedback_A.pdf`" in the "Feedback" folder, and enter the "`Feedback_A.pdf`" in the "File name" field in the row for enrolled student A.
