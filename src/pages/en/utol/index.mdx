...
{:#academic_affairs}
For an overview of how to use UTOL as staff in charge of academic affairs, please refer to “[学習管理システムUTOL (UTokyo LMS)](https://univtokyo.sharepoint.com/sites/utokyoportal/wiki/d/UTOL.aspx)” (in Japanese) in the Guide Book on UTokyo Portal (accessible only to UTokyo academic and administrative staff)
