...
{:#students}
For an overview of how to use UTOL as an enrolled student, please refer to “[Using UTOL as a student](students/)”. In addition, the following pages provide detailed explanations for each function.
- [Course search](students/course_search/)
- [Course registration](students/course_registration/)
- [Message](students/messages/)
- [Integrations with external tools](students/integrations/)
  - [Zoom integration](students/integrations/zoom/)
  - [Slack integration](students/integrations/slack/)
  - [MATLAB Grader integration](students/integrations/matlab_grader/)

### Using UTOL as a course instructor or TA
{:#lecturers}
For an overview of how to use UTOL as a course instructor or TA, please refer to “[Using UTOL as a Course Instructor or TA](lecturers/)”. In addition, the following pages provide detailed explanations for individual functions.
...
- [Integrations with external tools](lecturers/integrations/)
  - [Zoom integration](lecturers/integrations/zoom/)
  - [Slack integration](lecturers/integrations/slack/)
  - [MATLAB Grader integration](lecturers/integrations/matlab_grader/)

### Using UTOL as academic affairs staff

For an overview of how to use UTOL as academic affairs staff, please refer to “[Learning Management System UTOL (UTokyo LMS)](https://univtokyo.sharepoint.com/sites/utokyoportal/wiki/d/UTOL.aspx)” on UTokyo Portal (accessible only to UTokyo faculty and staff, available only in Japanese).
...
UTOL conducts scheduled maintenance on the first Tuesday of every month during the lunch break (12:20–13:00). Please refrain from using the service during this time, as system operations may be suspended.

In addition, advance notice will be provided on the following web pages for any maintenance requiring service suspension outside of the regular schedule:

- [System Failures and Maintenance Information](https://univtokyo.sharepoint.com/sites/utokyoaccount/SitePages/service-status.aspx) (Sign-in with a UTokyo Account is required to view this page)
- The "Important Information" section on the UTOL top page
