...
![the result viewing screen](./result.png){:.medium .border}![the result viewing screen during sharing](./sharing.png){:.medium .border}</figure>
   ...
   - In the case of quizzes, you can share the correct answers. Check the “Show correct answers to all” option at the bottom left on the first image during the results sharing. Participants will see a screen like the second image.
        ...
        <figure class="gallery">
![the Quiz results sharing screen](./quizsharingresults.png){:.medium .border}![the Quiz answers sharing screen](./answershare.png){:.medium .border}</figure>
