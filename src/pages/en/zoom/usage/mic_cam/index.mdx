...
* **Meeting-HD Video Quality**：Enabling this option allows you to use higher-quality video than standard. However, at UTokyo this feature is locked by the administrator and cannot be enabled by default. If you wish to use it, please contact us via [the support email form](https://utelecon.adm.u-tokyo.ac.jp/en/support/）.
