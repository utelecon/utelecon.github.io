...
import InstallAppPc from "@components/en/systems/zoom/InstallAppPc.mdx";
import InstallAppSp from "@components/en/systems/zoom/InstallAppSp.mdx";
...
{:#install-before}
<InstallAppPc support variant="individual" />
...
![](./ZoomApps_download_web.png){:.border .small}
...
1. Open the Zoom app.
2. Press "Schedule”.
   ![](./ZoomApps_schedule.png){:.border .small}
...
![](./ZoomApps_schedule_detail.png){:.border .medium}
...
![](./ZoomApps_schedule_invitation.png){:.border .medium}
...
![](./ZoomApps_newmeeting.png){:.border .small}
...
![](./ZoomApps_copylink.png){:.border .medium}
...
![](./ZoomApps_audio.png){:.border .small}
...
![](./ZoomApps_updatecheck_1.png){:.border .medium}
![](./ZoomApps_updatecheck_2.png){:.border .medium}
...
![](./ZoomApps_installed.png){:.border .medium}
...
* **Breakout room** (reference pages: [How to use Breakout Rooms](/en/zoom/usage/breakout/)): It is not possible to create a breakout room from the mobile app. Therefore, if you want to create a breakout room, please use the desktop app. However, it is possible to participate in a breakout room via the mobile app.
...
![](./ZoomApps_changedevice.png){:.border .medium}
