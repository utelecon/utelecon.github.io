...
First, please ensure that your issue is not due to known system failure or maintenance.
We will update the same page, so we appreciate your patience.
For inquiries about the posted information, please contact us via the email form instead of chat or online call.

<b class="box center">[System Failures and Maintenance Information](https://univtokyo.sharepoint.com/sites/utokyoaccount/SitePages/en/service-status.aspx)</b>
...
- [Troubleshooting for joining a class](/en/oc/join/)
{:.cards}
...
You have not completed the Information Security Education for the AY 2024. You have to take it and pass the confirmation test.
...
- <a href="/en/support/email-form" id="email-form" class="help-desk-list-button">
    #### Email form
    <div>
...
- <a href="/en/support/chat" class="help-desk-list-button">
    #### Chat
    <div>
      - This service is suitable for situations like these:
...
- <a href="https://login.adm.u-tokyo.ac.jp/support/" class="help-desk-list-button">
    #### Online call
    <div>
      - This service is suitable for situations like these:
