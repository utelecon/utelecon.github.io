...
In UTokyo Slack, who the representative (the person responsible for the management and operation) of each workspace is recorded, in addition to the information on owner/administrator roles stored in the system. At the time the workspace is created, the person who has submitted the application form is regarded as the representative. If you wish to transfer the representative to another person, proceed according to the following procedure.
