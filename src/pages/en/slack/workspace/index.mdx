...
In UTokyo Slack, who the representative (the person responsible for the management and operation) of each workspace is recorded, in addition to the information on owner/administrator roles stored in the system. At the time the workspace is created, the person who has submitted the application form is regarded as the representative. If you wish to transfer the representative to another person, both the current representative and the new representative should contact us using the [Contact Form](https://forms.office.com/r/pbKNVZzsMS) with the following information.
