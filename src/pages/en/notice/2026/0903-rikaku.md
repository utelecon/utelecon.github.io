---
title: Handling of the 2026 Academic Year A Semester Courses on UTOL
---

<div style="text-align: right;">
<span>September 3, 2026</span><br />
...
In the A semester of 2026, course confirmation dates will be set uniformly as follows:
...
The course confirmation date for the Faculty of Economics is as follows:

- A1 Term/A Semester: Sunday, October 18
- A2 Term: Sunday, December 20

There have been no course confirmations set for the Graduate School of Arts and Sciences. **Self-registration will be available even after the course registration period ends**. Please be sure not to forget to complete the course registration procedure as needed.

### 3. Changes in the course access status
...
#### October 21~: "Self-Registration" is unavailable

You will no longer be able to access courses using "Self-Registration" starting from early in the morning of October 21, following the October 20 course confirmation date for the A1 Term. However, you may still be able to access the course if the course instructor changes the settings for the relevant course.
...
### 5. There are course settings that differ from regular settings
...
### 6. Handling of Semester/Term and the Course Confirmation Date

Depending on the course, the dates offered may differ from the standard such as A1 and A2. Please refer to the table below for the handling of the Semester/Term and the course confirmation dates. For the Junior Division of the College of Arts and Sciences, please refer to the table above.

| Semester/Term (Japanese) | Semester/Term (English) | Course Confirmation Date |
| ------------------------ | ----------------------- | ------------------------ |
| 冬学期                   | Winter semester         | October 15               |
| 集中                     | Intensive               | October 15               |
| 年度跨り                 |                         | October 15               |
| Ａ１                     | Ａ１                    | October 15               |
| Ａ２                     | Ａ２                    | December 10              |
| Ｗ                       | Ｗ                      | February 7               |
| A1A2                     | A1A2                    | October 15               |
| A1A2S1                   | A1A2S1                  | October 15               |
| A2S1                     | A2S1                    | December 10              |
| A1A2W                    | A1A2W                   | October 15               |
| A2W                      | A2W                     | December 10              |
| WS1                      | WS1                     | February 7               |
| WS1A1                    | WS1A1                   | February 7               |
| Ｗ(農)                   | Ｗ                      | February 7               |
| Ａ                       | A                       | October 15               |
