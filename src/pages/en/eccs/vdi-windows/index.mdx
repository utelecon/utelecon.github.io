...
Please note that [OneDrive](/microsoft/onedrive/#storage_capacity) and [Google Drive](/en/google/drive/#using_with_utokyo_account) have storage limits. Therefore, please be careful not to place unnecessarily large files in folders that are synchronized with the cloud.
