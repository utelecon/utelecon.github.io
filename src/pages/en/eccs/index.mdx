...
To use ECCS, you must first obtain the Right to use the ECCS. Once granted, you can access ECCS using your UTokyo Account's common ID (10-digit number) and password. For more details on obtaining Right to use the ECCS, please refer to "[Apply for Right to use the ECCS](./overview/right-application/)".
