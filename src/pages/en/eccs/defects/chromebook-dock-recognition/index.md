---
title: Issues where the dock is not detected when starting up a Chromebook (external display not showing or accessories such as the keyboard not being recognized)
breadcrumb:
...
1. **While holding down the Refresh key (🔄) on the top row of the keyboard,** press the power button to start up. You may release them once the Chromebook logo (the "Chromebook Plus" text) appears on the screen.
    ![The Refresh key is the third key from the left in the top row of the Chromebook's keyboard.](./img/reset.drawio.png)
