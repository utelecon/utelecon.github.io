...
- Check resource budget usage from the Azure Portal.
  - You can check the usage status of Microsoft Azure, but you cannot check the **Free Tier** and **Guaranteed Free Tier**. Please check from the management page of the UTokyo Azure:New Application page.
...
- **have privileges**
  ...
  - Check resource usage from the Azure Portal.
    - There are some functions for which you do not have permission.
- **have no privileges**
