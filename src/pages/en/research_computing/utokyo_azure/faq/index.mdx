...
<HelpItem lang="en" type="details">
  ...
  <Fragment slot="solution">Yes. You can use the UTokyo Microsoft License with UTokyo Azure. When configuring a virtual machine, check **"I confirm I have an eligible Windows 10/11 license with multi-tenant hosting rights."**</Fragment>
</HelpItem>
