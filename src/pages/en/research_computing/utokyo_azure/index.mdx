...
#### [UTokyo Slack channel](https://app.slack.com/client/E0312P7H7MX/C088H15FH3L?_gl=1*163sxt6*_gcl_au*MTUzNTE1MDYzOS4xNzM2ODIwNzQw)
- Joining to `UTokyo Azure Users Community`
- How to Join > [Joining an open workspace in UTokyo Slack](https://utelecon.adm.u-tokyo.ac.jp/en/slack/join)
...
- For inquiries about subscriptions or quota requests, contact Microsoft Support directly through the UTokyo Azure UI.
