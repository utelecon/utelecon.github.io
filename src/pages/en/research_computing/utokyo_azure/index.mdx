...
<div class="box">
UTokyo Azure subscriptions have a unique feature that automatically cancels your subscription when 90% of the Guaranteed Free Tier has been used up; this feature is enabled by default. This is a feature for users who want to be sure to stop using the service within the Guaranteed Free Tier, but at that point the subscription will be canceled immediately, making it impossible to recover and preventing access to resources. **If you do not want your data or other resources to be canceled, please visit the [**UTokyo Azure New User Application Management Page**](http://azure.itc.u-tokyo.ac.jp/list) and remember to disable the "Automatic Suspension" feature for any subscriptions you do not want to cancel.**
</div>
