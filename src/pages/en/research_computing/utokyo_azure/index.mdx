...
- Make it available for a wide range of uses without restricting fields, provided the purpose is research or education.  
  - Note: Usage for administrative tasks is not permitted. For administrative purposes, please continue to use the [Microsoft licenses](https://www.u-tokyo.ac.jp/focus/en/articles/z1701_00012.html) already contracted for the entire university.
