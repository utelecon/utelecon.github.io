...
<figure class="gallery">
  ![](./img/iphone02-setup_home_en.png){:.border}![](./img/iphone03-setup_home_popup_notify_en.png){:.border}
</figure>
...
<figure class="gallery">
    ![](./img/iphone06-home_disconnected_en.png){:.border}![](./img/iphone07-signin_en.png){:.border}
</figure>
