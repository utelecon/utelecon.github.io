...
<figure class = "gallery">![](./img/win03-install-1.png){:.medium.center.border}![](./img/win04-install-2.png){:.medium.center.border}![](./img/win05-install-3.png){:.medium.center.border}</figure>
