...
**Step A:** Go to [https://vpn1.adm.u-tokyo.ac.jp/](https://vpn1.adm.u-tokyo.ac.jp/). Unless you are already signed in, the UTokyo Account sign-in page will appear. Sign in with your UTokyo Account.
...
**Step C:** Follow the setup wizard screens below to proceed with the installation. In the End User License Agreement, please select “I accept the terms in the License Agreement” and click “Next” to proceed.

<p align="center">
  <img src="img/win03-install-1.png" width="32%">
  <img src="img/win04-install-2.png" width="32%">
  <img src="img/win05-install-3.png" width="32%">
</p>
...
**Step F:** After clicking the “Connect” button, unless you are already signed in, the UTokyo Account sign-in page will appear. Sign in with your UTokyo Account.
...
**Step H:** To view the current connection status, click on the “Cisco Secure Client” icon again. If the window displaying “Connected to vpn1.adm.u-tokyo.ac.jp” illustrated below appears, your device is connected to the UTokyo VPN.
