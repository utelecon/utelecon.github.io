...
Furthermore, general information on how to use OneDrive can be found in [“OneDrive”(an English translation is planned)](.), and instructions on how to share files can be found in [“Sharing files with OneDrive” (an English translation is planned)](share). Please refer to them for more information. 
...
1. Please click the “My files” button in the menu on the left side of the screen. 
    - “My files” is the top-level folder in OneDrive. ![](img/basic-move-1.png){:.medium.center}
...
1. Please click on the “Add new” button at the top of the screen. ![](img/basic-add-1.png){:.medium.center}
1. A list of file formats is displayed. Please choose the file format you wish to create.![](img/basic-create-1.png){:.medium.center}
...
1. Please click on the “Add new” button at the top of the screen.![](img/basic-add-1.png){:.medium.center}
1. Please choose “Files upload” if you wish to upload a single file. If you wish to upload all the files in a folder, please choose “Folder upload”. ![](img/basic-upload-1.png){:.medium.center}
...
1. Please right-click the file you wish to download and select “Download”.![](img/basic-download-1.png){:.medium.center}
...
1. Please click on the “Add new” button at the top of the screen and choose the “Folder” button.![](img/basic-create-folder-1.png){:.medium.center}
1.A screen titled “Create a folder” will be displayed. Please enter the name for the new folder.![](img/basic-create-folder-2.png){:.medium.center}
...
1. Please right-click the file you wish to move and select “Move to”. ![](img/basic-move-file-1.png){:.medium.center}
...
1. Please click “Move here” at the bottom of the screen. The file will be moved to the folder you chose. ![](img/basic-move-file-2.png){:.medium.center}
