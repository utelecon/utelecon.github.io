---
title: Sharing Files on OneDrive
breadcrumb:
  title: Sharing Files
---

import OneDriveExternalSharing from "@components/en/OneDriveExternalSharing.mdx";
...
1. Change the settings of the shared link to be created as necessary. For details on each setting item, see “[Types of Shared Links That Can Be Created](#link-type)”.![](img/share-create-link-3.png){:.medium.center.border}
	...
	<details>
		<summary>If you want to block downloading</summary>
