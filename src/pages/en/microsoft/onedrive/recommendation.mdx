...
breadcrumb:
  title: ecommended Usage for Sharing Files
---
...
For an overview of how to share files on OneDrive, please refer to "**[Sharing Files on OneDrive](../share/)**" (in Japanese). Additionally, a general introduction to OneDrive can be found on "[OneDrive](../)" and the basic usage instructions can be found on "[Basic Usage of OneDrive](../basic/)”. 
...
For detailed procedures, please refer to "[Creating a New Shared Link](../share/)" in "[Sharing Files on OneDrive](../share/#create-link)" (in Japanese).

Faculty and staff can also jointly edit files/folders with internal other members of the university by using the Teams team folder in Microsoft Teams. In thisat case, you can access files stored in Microsoft Teams directly from OneDrive by creating a shortcut to your Teams team folder in OneDrive. In this way, you can edit files or folders in almost the same way as you would jointly edit files in a folder created in OneDrive.

Please refer to "[When accessing a team folder in Teams using OneDrive](/microsoft/teams_team_folder/#access-from-onedrive)" in the "[Teams Folder](/microsoft/teams_team_folder/)" for details.

#### Publicizing Files to Members of the University
{:#univ-release}
If you want to publicize files to members of the university such as students, faculty, and or staff, it is recommended that you set the sharing target to "**People in The University of Tokyo**", and create **a shared link** with the type of access rights to "**Can view**" and notify recipients via email, chat tools, etc.
