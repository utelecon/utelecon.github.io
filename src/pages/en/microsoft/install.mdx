...
1. Access “Microsoft 365 Apps” screen and sign in with your UTokyo Account.
  **[Microsoft 365 Apps](https://m365.cloud.microsoft/apps/?auth=2)**{:.box.center}
  For the sign-in procedure, see **[Signing in with UTokyo Account](#signin)**.
1. Click "Install apps" at the top right of the screen and then click "Microsoft 365 Apps" in the menu that appears.
