...
If you are using UTokyo Zoom with an email other than the Common ID (the first 10-digit numerical part of the UTokyo Account) ECCS Cloud Email `1234567890@g.ecc.u-tokyo.ac.jp` (e.g. email address named after your choice `xxxx@g.ecc.u-tokyo.ac.jp`), signing in with UTokyo Account will not be available after the transfer.

If you wish to use this email address, signing in from the Zoom sign-in page [https://zoom.us/signin](https://zoom.us/signin) with its password is temporarily available. Please note that it is impossible to sign in from UTokyo Zoom page using a non-Common-ID account.

As previously announced, these Zoom accounts are to be terminated. You are advised to switch to UTokyo account. Please read “[Using Zoom with Non-UTokyo Account Sign-in](/en/notice/zoom-address-new/)” on how to switch to UTokyo Account `1234567890@utac.u-tokyo.ac.jp`, after the transfer.
