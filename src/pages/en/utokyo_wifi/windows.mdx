---
title: Using UTokyo Wi-Fi on Windows
breadcrumb:
  title: Using UTokyo Wi-Fi on Windows
---
...
{:#turn-on}
Select the globe icon in the taskbar, and then select the fan-shaped “Wi-Fi” icon to enable the Wi-Fi function. If there is only the fan-shaped “Wi-Fi” icon but no globe icon, simply select the former.
![](./img/windows11-turnon-globe.png){:.medium.center.border}

![](./img/windows11-turnon-sector.png){:.medium.center.border}
...
![](./img/windows11-deleteprofile.png){:.medium.center.border}
