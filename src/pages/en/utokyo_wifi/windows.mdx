...
<div class="box">
  Support for Windows 10 ended on October 14, 2025 ([detailed information](/notice/2025/1014-win10office-eol/)). Operating systems and applications that have reached end-of-life no longer receive security updates or other support, and continuing to use them poses significant risks. This page still contains information about Windows 10, but please adapt the content accordingly when reading.
</div>
