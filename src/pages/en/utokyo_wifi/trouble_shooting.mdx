...
3. If you have not already signed in to your UTokyo Account, the UTokyo Account sign-in page will appear. Please sign in.
   <HelpHaveNoAccess system="the UTokyo Wi-Fi" type="details" />
...
The official support contact provided university-wide is [utelecon Support Desk](/en/support/). Four inquiry methods are available: text chat, online call, on-site conversations, and email.

- For inquiries submitted via email, system administrators will investigate connection logs and other relevant data if necessary and provide a response.
- For chat, online call, and on-site conversations, troubleshooting that involves connection logs or other information accessible only to system administrators cannot be performed. If such investigation is required, you will be smoothly guided to continue the inquiry via email. In addition, as a preliminary step before corresponding by email, these support channels can also assist you in narrowing down and identifying the source of the problem.
