  ...
  <tr>
    ...
    <td>
      <ul style="margin-top: 0; margin-bottom: 0;">
        ...
        <li>Issued by: <code>NII Open Domain CA - G8 RSA</code></li>
        <li>Root Certificate: <code>Security Communication RootCA2</code></li>
        <li>Fingerprint SHA-1: </li>
          <ul>
            <li><code style="word-break: break-all;">9F:8F:A6:74:0B:4C:3D:84:E4:6A:81:2E:F0:CB:7B:B4:43:55:7D:F8</code></li>
          </ul>
        <li>Fingerprint SHA-256:</li>
          <ul>
            <li><code style="word-break: break-all;">A9:B4:A7:2C:14:85:27:F1:64:53:A7:16:FC:90:7C:6C:D0:21:AB:E8:4A:ED:CE:80:6F:A8:69:53:B6:F2:40:12</code></li>
          </ul>
      </ul>
