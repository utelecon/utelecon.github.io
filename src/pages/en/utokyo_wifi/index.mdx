...
UTokyo Wi-Fi is a Wi-Fi service available to members of the University of Tokyo (UTokyo) for educational and research purposes. Currently, UTokyo Wi-Fi is available in most locations of the campus, including Hongo, Komaba, Kashiwa, and other campuses. Please refer to the [Before using UTokyo Wi-Fi](#before-to-use) to confirm what you need to know before using UTokyo Wi-Fi.
...
* [Using UTokyo Wi-Fi on Windows 10](windows)
* [Using UTokyo Wi-Fi on macOS](macos)
* [Using UTokyo Wi-Fi on Android](android)
* [Using UTokyo Wi-Fi on iPhone and iPad](ios)
{:.cards}
