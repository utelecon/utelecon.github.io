...
UTokyo Wi-Fi accounts expire at the end of April of the following fiscal year. New accounts can be issued before the start of each fiscal year, so if you wish to continue using the service, you must reissue an account each fiscal year. For details on how to reissue an account, please refer to the [Procedure for reissuing or re-setting up your account](#reissue-account).

### If you suddenly lose Wi-Fi connection
{:#suddenly-cannot-connect}
If you suddenly lose connection to UTokyo Wi-Fi when it was working fine before, there may be a problem with your UTokyo Wi-Fi account. To check this, try signing in to your [UTokyo Wi-Fi Account Menu](https://acm.wifi.adm.u-tokyo.ac.jp/secure/user_applies/index/1/).
...
- The expiry date of your UTokyo Wi-Fi account will be displayed on the screen immediately after you sign in. If the expiry date has expired, please [reissue or re-set up your account](#reissue-account).
