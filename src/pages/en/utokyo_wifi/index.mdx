  ...
  <tr>
    ...
    <td>
      ...
      <ul style="margin-top: 0; margin-bottom: 0;">
        ...
        <li>Issued by: <code>NII Open Domain CA - G7 RSA</code></li>
        <li>Root Certificate: <code>Security Communication RootCA2</code></li>
        <li>Fingerprint SHA-1: <code style="word-break: break-all;">ED:AA:E5:70:E7:96:A0:6B:E7:78:C2:D6:7A:56:5F:A4:22:19:A1:B2</code></li>
        <li>Fingerprint SHA-256: <code style="word-break: break-all;">FF:3B:CF:6B:72:3B:0D:F7:63:76:92:F1:CF:90:BC:60:18:3D:88:03:27:4C:A3:FB:67:BE:6E:72:58:F0:B8:E4</code></li>
      </ul>
      *&ensp;If you are prompted to enter the "domain" of the certificate, enter <code style="word-break: break-all;">u-tokyo.ac.jp</code>.
    </td>
  </tr>
</table>
