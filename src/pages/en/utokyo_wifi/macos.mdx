---
title: Using UTokyo Wi-Fi on macOS 26
breadcrumb:
  title: Using UTokyo Wi-Fi on macOS 26
---
...
<Intro kindOfTerminal="terminal with macOS 26 Tahoe" confirmedTerminal="（MacBook Pro with macOS 26 Tahoe）"/>
...
<figure class="gallery">![](img/macos26-turnon1.png){:.medium.center.border}![](img/macos26-turnon2.png){:.medium.center.border}</figure>
...
Select the SSID you found in Step 2, and select the “...” icon on the right side. Then select “Forget This Network” on the displayed screen.  When a screen asking “Forget Wi‑Fi “0000UTokyo”?” appears, select “Remove”.
<figure class="gallery">![](img/macos26-deleteprofile1.png){:.medium.center.border}![](img/macos26-deleteprofile2.png){:.medium.center.border}</figure>
...
![](img/macos26-createprofile.png){:.medium.center.border}
...
* During the connecting operation, a screen asking if you trust the certificate may appear. To verify whether the certificate is correct, compare the "server fingerprint" of the displayed certificate with the fingerprint listed in 「[Connect Configuration](/en/utokyo_wifi/#connect-configuration)」. If they match, trust the certificate.
    * In addition, there are two types of fingerprints (SHA-1 and SHA-256) listed on [Connect Configuration](/en/utokyo_wifi/#connect-configuration);matching one type will suffice. ![](img/macos26-certificate.png){:.medium.center.border}
