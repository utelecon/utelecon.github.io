---
title: Using Utokyo Wi-Fi on macOS 26/15
breadcrumb:
  title: Using Utokyo Wi-Fi on macOS 26/15
---
...
<Intro kindOfTerminal="terminal with macOS 26 Tahoe/macOS 15 Sequoia" confirmedTerminal="（MacBook Pro with macOS 26 Tahoe）"/>
