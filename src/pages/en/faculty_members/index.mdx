...
If you are a staff member, please see the "<a href="/en/staff_members/">Getting Ready for ICT Systems at the UTokyo（for Staff Members）</a>" page.
...
"<a href="/en/docs/guideline">The Tools Usage Guideline for Online Class Since S Semester 2021</a>" is the established guideline for online classes. Please also check your department’s policy on conducting online classes because each department may have its own policy.
...
![overall system](overall_system_en.png)
...
In the following, the systems of the UTokyo and how to use them are explained individually.
...
- **[ECCS Terminals](https://www.ecc.u-tokyo.ac.jp/en/terminal.html)**
...
- **[a Comprehensive Antivirus Software License (UTokyo Antivirus License)](/antivirus/)**
