...
In explaining the information system of the UTokyo, we will explain the whole picture of the system using the materials of the briefing session held by the UTokyo.
...
![](overall_system_en.png)

At the start of Semester A, the UTokyo provides a briefing session for faculty and staff on the overview of each of the UTokyo systems. The diagram shown above is part of the presentation materials. The information systems provided by the UTokyo are diverse and difficult to grasp, but the explanations of each system and its relationship are provided at the briefing sessions to make them easier to understand. Please refer to "[Information Systems and Communication Tools at the UTokyo (conducted in English)](/en/events/2024-09-13/)" for the specific schedule and materials.

In the following pages, the systems of the UTokyo and how to use them are explained individually.
...
You can also create a meeting room using the app. Please check [this page](/en/zoom/misc/app) for more details.
