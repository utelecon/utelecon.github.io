...
<b class="box">
An information session titled "<a href="/events/2026-03-16/">Information Session on ICT Systems and Tools for UTokyo Members (Conducted in Japanese)</a>" will be held on March 16, 2026 at 3:30 PM. Please refer to this page as well.
{/* An information session titled “<a href="/en/events/2026-03-16/">Information Session on ICT Systems and Tools for UTokyo Members (Conducted in Japanese)</a>” was held on March 16, 2026. Materials and recordings of the session are provided on the linked page. Please refer to this page as well. */}
</b>
...
At UTokyo, classes are offered in several formats. The primary format remains the traditional face-to-face class; however, various forms of online classes are also provided. For an overview of key considerations, practical examples, and institutional policies related to each format, please refer to the "[Exploring Better Practices for Online Teaching](/online/courses/)" page (in Japanese).
...
- UTOL’s attendance management function: This is a feature that allows you to manage attendance by sending a “one-time password” to attendees via Zoom or other means and asking them to enter it.
    - For more information on how to use the feature, please see “[Using the Attendance Function in UTOL (for Course Instructors and TAs)](/en/utol/lecturers/attendances/)”.
