...
import ZoomSigninBrowser from '@components/en/ZoomSigninBrowser.mdx'
import Courses from '@components/en/Courses/index.astro'
...
<Courses pageSlug="faculty_members" />
...
MFA setup is not mandatory at this time, but it is recommended for better security of your UTokyo Account. Please follow the setup procedures in the “**[Initial Setup Procedures for Multi-Factor Authentication for UTokyo Accounts](/en/utokyo_account/mfa/initial)**” page.
