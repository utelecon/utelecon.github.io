...
- **[Educational Campus-Wide Computing System (ECCS)](/en/eccs/)**
  - A programming environment and software for various purposes, such as statistics and 3DCG, are already installed and can be used without going through the installation procedure. It can also be used for classes by making a prior reservation.
