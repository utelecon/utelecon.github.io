...
<YouTube src="https://www.youtube.com/embed/l84Aa1esNqI" /> */}
...
1. Enter your UTokyo Account username and password in the sign-in page.
1. Verify your identity using MFA. The procedure differs by the verification method you use. Please follow the instructions on your screen.
    ...
    - **Phone Number (verification via call)**: You will receive a phone call, asking you to press the pound key (#) on your phone. Press the key and end the call. (To display the pound key on your smartphone during the call, press the “keypad” button.)　※A phone capable of tone dialing is required.
    <details>
...
1. Access the [UTokyo Account User Menu](https://utacm.adm.u-tokyo.ac.jp/UserMenu/LoginServlet).
2. Sign in with your UTokyo Account if prompted.
3. Click “Start using your UTokyo Account” in the left menu. ![](./user_menu_1.png)
4. Read the UTokyo Account instructions carefully, and find “Start using your UTokyo Account” at the bottom of the page. Answer “Yes” and click “SAVE”. ![](user_menu_2.png)

<div class="box">
You have completed the initial setup procedures for UTokyo Account, <strong>but it will take about 30 minutes for the account settings to be reflected in the system after these procedures</strong>. If you want to use systems that do not allow you to sign in until the multi-factor authentication settings are completed, please be patient and wait for a while.
</div>
...
If you are in trouble in using your UTokyo Account and the MFA, you need to “re-registration MFA”. Please visit “[Reregistering Verification Method for UTokyo Accounts](../reregister/)” for more information. In case you lose access to all verification methods and are unable to sign in to the UTokyo Account, the UTokyo Account Identity Verification Service allows you to reregister your verification method by yourself at any time. Please review the “[UTokyo Account Identity Verification Service](../../ident-myna/)”.
