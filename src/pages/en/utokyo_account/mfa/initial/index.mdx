...
<div class="box">
You have completed the initial setup procedures for UTokyo Account, <strong>but it will take about 40 minutes for the account settings to be reflected in the system after these procedures</strong>. If you want to use systems that do not allow you to sign in until the multi-factor authentication settings are completed, please be patient and wait for a while.
</div>
