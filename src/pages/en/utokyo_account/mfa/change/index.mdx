...
import altAddMethod from "@components/en/mfa/alt_add_method.png";
...
1. Find “Default sign-in method:” on the [Security info page](https://mysignins.microsoft.com/security-info?domain_hint=univtokyo.onmicrosoft.com)．
    <img src="change_default_signin_method.png" />
