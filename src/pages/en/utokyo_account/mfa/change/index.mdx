...
import altAddMethod from "@components/en/mfa/alt_add_method_en.png";
...
Registered verification method can be changed from the **[Security info page](https://mysignins.microsoft.com/security-info?domain_hint=univtokyo.onmicrosoft.com)**.

## Adding Verification Methods
{:#add}

In the [Security info page](https://mysignins.microsoft.com/security-info?domain_hint=univtokyo.onmicrosoft.com), you can add verification methods by following the procedures given in [“Step 2: Add Alternative Verification Methods” in the “Initial Setup Procedures for Multi-Factor Authentication for UTokyo Accounts” page](../initial/#alternative).

<ArrowOverlay image={altAddMethod} x={950} y={445} angle={180} />
...
1. Find “Default sign-in method:” on the [Security info page](https://mysignins.microsoft.com/security-info?domain_hint=univtokyo.onmicrosoft.com).
    <ArrowOverlay image={altAddMethod} x={1520} y={345} angle={180} />
...
1. Find the verification method you wish to edit in the list of verification methods on the [Security info page](https://mysignins.microsoft.com/security-info?domain_hint=univtokyo.onmicrosoft.com), and click “Change” on the right of the method. 
    <ArrowOverlay image={altAddMethod} x={1810} y={540} />
...
1. Find the method you wish to edit in the list of verification methods on the [Security info page](https://mysignins.microsoft.com/security-info?domain_hint=univtokyo.onmicrosoft.com), and click “Delete” on the right of it.
    <ArrowOverlay image={altAddMethod} x={2150} y={540} />
