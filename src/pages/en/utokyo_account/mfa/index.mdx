...
In case you lose access to all verification methods and are unable to sign in to the UTokyo Account, the UTokyo Account Identity Verification Service allows you to reregister your verification method by yourself at any time. However, to use this service, you must meet several requirements, such as having already completed the pre-link for the “UTokyo Account Identity Verification Service”. Please review the “Requirements for Reregistering Using the Identity Verification Service”.
