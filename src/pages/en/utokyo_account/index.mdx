...
- For teachers: Please refer to the following two pages.
  - "[Getting Ready for ICT Systems at the University of Tokyo (for Faculty Members)](/en/faculty_members/)"
  - [UTokyo Portal: "Initial Setup of the UTokyo Account(in Japanese)"] (https://univtokyo.sharepoint.com/sites/utokyoportal/wiki/d/UTokyo_Account_Initial_Settings.aspx)(*You must sign in with your UTokyo Account to view this page)
- For staff: [UTokyo Portal: "Initial Setup of the UTokyo Account(in Japanese)"](https://univtokyo.sharepoint.com/sites/utokyoportal/wiki/d/UTokyo_Account_Initial_Settings.aspx)(*You must sign in with your UTokyo Account to view this page)
