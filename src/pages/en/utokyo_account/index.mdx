...
- The username of a UTokyo Account consists of a 10-digit number called the **“Common ID”**, followed by the domain `@utac.u-tokyo.ac.jp` to indicate a University of Tokyo account. You use this username to sign in to ICT systems, but depending on the system, you may sometimes be able to sign in using just the Common ID.
