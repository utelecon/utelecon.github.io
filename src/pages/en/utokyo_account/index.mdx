...
- For faculty members: Please refer to the following two pages.
  ...
  - [UTokyo Portal: "UTokyo Accountの初期設定(Initial Setup of the UTokyo Account)"(in Japanese)] (https://univtokyo.sharepoint.com/sites/utokyoportal/wiki/d/UTokyo_Account_Initial_Settings.aspx)(*You must sign in with your UTokyo Account to view this page)
- For staff members: [UTokyo Portal: "UTokyo Accountの初期設定(Initial Setup of the UTokyo Account)"(in Japanese)](https://univtokyo.sharepoint.com/sites/utokyoportal/wiki/d/UTokyo_Account_Initial_Settings.aspx)(*You must sign in with your UTokyo Account to view this page)
