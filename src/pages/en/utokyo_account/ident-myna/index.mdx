...
Please note that the Identity Verification Service requires a My Number Card. If you do not have a My Number Card, you will not be able to complete the pre-link procedure. Also, **the Identity Verification Service is an optional service; even without registering for it, you can use UTokyo's information systems as usual**.
