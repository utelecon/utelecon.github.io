...
## Step 1
{:#app-setup}
The UTokyo Account Identity Verification Service uses the "Digital Identification App" provided by the Digital Agency. First, you need to install this app and create a user registration.
...
Use your My Number Card and the digital identification app to perform identity verification. The procedure is slightly different for **[the case of using only a smartphone](#auth-smartphone)** and **[the case of using both a PC and a smartphone](#auth-pc)**. Please follow the steps applicable to your situation.
...
4. Tap "Next" to proceed with the authentication steps.
    ![](./images/lets start the authentication.png){:.border}
