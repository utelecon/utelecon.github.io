...
1. Tap "Verify identity with My Number Card" This will redirect you to the Digital Identification App. If the authentication steps menu appears, the process is working correctly.
    ...
    {/* ここから共通 */}
1. Follow the instructions in the app to authenticate using biometrics or a passcode.
1. Tap "Start" to proceed with the authentication steps.
    ![](./images/auth_app_initial_1.png){:.border}
1. Enter the PIN for the "electronic certificate of user proof".
    ![](./images/auth_app_pass1.png){:.border}
1. Enter the PIN of the "app to support entering items on the card" (previously referred to as "PIN for Card Info Input Support"). If it is the same as the previous PIN, you can skip this step by tapping "Insert same PIN".
    ![](./images/auth_app_pass2.png){:.border}
1. Follow the instructions in the app, tap the "Read the card" button, and scan your My Number Card with your smartphone.
...
1. A screen will appear asking for permission to authenticate with the UTokyo Account Identity Verification Service. After reviewing the privacy policy and terms and conditions, tap "Allow".
    ...
    {/* ここまで共通 */}
1. Tap "Return to the service in use" in the Digital Identification App or wait 10 seconds after the screen changes. You will be returned to the UTokyo Account Identity Verification Service.
...
1. Click "Verify identity with My Number Card". A QR code will be displayed.
    ![](./images/service_step1.png){:.border}{:.medium}

1. Scan the large QR code with the smartphone you set up in Step 1. If the QR code becomes invalid, click "Refresh QR code" below it to generate a new one. **Do not close the PC page after this**.
...
1. Enter the 6-digit number displayed on your smartphone into your PC. If it expires, refresh the 6-digit number.

    {/* ここから共通 */}
1. Follow the instructions shown on the app to authenticate using biometrics or a passcode.
1. Tap "Next" to proceed with the authentication steps.
...
1. Your work on the smartphone is now complete. Return to the PC screen.
...
1. Click "Link your UTokyo Account and linked ID as described above" to link the accounts.
    ![](./images/service_step3.png){:.border}{:.medium}
1. If a button that says "Unlink the above" appears, the linkage has been successfully completed.
