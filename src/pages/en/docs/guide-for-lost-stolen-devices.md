---
title: Device Loss and Theft Prevention Guide (For students, faculty and staff)
breadcrumb:
  title: Device Loss and Theft Prevention Guide
---
...
* [Encrypt your disk](#disk-encryption)
* [Regularly back up your data](#regular-backup)
* [Set up remote lock (Windows) or remote data wipe (macOS) in advance using the "Find" feature](#remote-lock-wipe)
* [Know the contact point and initial response procedures in case your device is lost](#contact-procedure)
...
8. Follow the instructions to restart your PC; encryption will begin.
...
##### Windows 11
1. Open Settings.
2. Select "Privacy & Security" and then "Find my device."
3. Turn on "Find my device."

##### Windows 10

1. Open Settings.
2. Select "Update & Security" and then "Find my device."
3. Turn on "Find my device."

#### How to Remotely Lock (if device is lost)

1. Go to [https://account.microsoft.com/devices](https://account.microsoft.com/devices) and sign in.
2. Select the "Find my device" tab.
3. Choose your device and click "Find" to display its location on a map.
4. If found, select "Lock" and then "Next."
