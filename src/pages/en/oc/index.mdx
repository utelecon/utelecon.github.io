...
<EResourceAccessNotice variant="list" />
...
export const about_microsoft =
  "This is a Microsoft license offered to UTokyo Account holders. This license will enable you to download Microsoft Office applications, such as Word and Excel, and use online Microsoft tools for free with your UTokyo Account. Similar to Google Workspace, some pages can only be accessed with a university account, so you will need to set up your university account even if you already have a Microsoft account.";
...
- **Exercise: Try logging in**
    <UtolLogin support />
- **On your first login: Choose your consent setting for data use in research**
  When you log in to UTOL for the first time, a screen asking for your consent to the use of data recorded in UTOL for educational research and system improvement will be displayed.
  Review the information, particularly the *UTOL-Specific Exceptions to the Privacy Policy*, select either **“I Consent”** or **“I Do Not Consent”**, and then click **“Save.”** You can continue to use UTOL as usual regardless of your choice, and you can change this setting at any time.
  ![UTOL consent screen for the use of data in research. Review the information, select “I Consent” or “I Do Not Consent,” and click “Save.”](img/utol_data_use_consent.png){:.border .medium}
- **Optional task: Link notifications with email / LINE / Slack**
  You can receive notifications via email, LINE, or [UTokyo Slack](/en/slack/) when there are updates to courses you are enrolled in or are in charge of. See ["Setting notifications on UTOL"](/en/utol/notification/) page for setup instructions.
{:.procedure}
...
- **Optional task: Use Word or Excel on your computer** (if you already have them installed, you can continue using them. If you want to use UTokyo Microsoft License with your existing Microsoft Office applications, please see "[Installing Office Apps with UTokyo Microsoft License > Sign in](/en/microsoft/install/#signin)".)
