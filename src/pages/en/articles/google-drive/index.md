...
<strong class="box">
  In August 2023, the method for creating shared drives in ECCS Cloud Email was changed. The description in this article refers to the method used before that time. For information on the new creation method, please see the <a href="/en/google/drive/storage/">"ECCS Storage Management System."</a>
</strong>
