...
* `10-digits-ID@utac.u-tokyo.ac.jp`(e.g. `1234567890@utac.u-tokyo.ac.jp`)
  ...
  * You might use your UTokyo Account as your username when logging into the system. The 10-digit number preceding the `@` symbol is known as the common ID. Some system require you to enter only this common ID when logging in.
