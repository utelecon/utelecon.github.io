...
東京大学のほか，日本の多くの大学や研究機関等でも，[学術認証フェデレーション「学認（GakuNin）」](https://www.gakunin.jp/)の仕組みを通じて，各大学等のアカウントで利用可能です．また，アカウントを持たない相手との間でファイルを送受信することもできます（送信者・受信者のどちらかがアカウントを持っていれば十分です）．
