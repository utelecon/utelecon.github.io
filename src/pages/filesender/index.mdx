...
NII FileSenderは，国立情報学研究所(NII)の学認参加機関が利用できるファイル転送サービスです．東京大学の構成員は，UTokyo Accountを用いてNII FileSenderを利用することができます．

### 利用上の制約

- 一度に転送できる最大容量は10GB，最大ファイル数は30個です．
- アップロードしたファイルの有効期限は最長で20日間です．
- 送信者・受信者の少なくとも一方が，東京大学を含む学認参加機関の構成員である必要があります．
...
- **多数の人への共有**: 受信者としてメールアドレスの指定が必要であり，指定できるメールアドレスは最大100個です．また「東京大学の構成員であれば誰でもアクセス可能」といった，範囲を限定しての公開はできません（ただし，ダウンロードにNII FileSenderへのログインを要求することは可能です）．
