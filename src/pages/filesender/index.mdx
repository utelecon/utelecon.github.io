...
- **学内の不特定の人への共有**: 「東京大学の構成員であれば誰でもアクセス可能」といった，範囲を限定しての公開はできません（受信者がファイルをダウンロードする際に，単にメールを受け取ったりリンクを知っていたりするだけでなく，NII FileSenderへのログインも必須となるような設定も可能です．しかしNII FileSenderには，東京大学以外の多くの大学等のアカウントでもログインできます）．
