...
export const about_utokyo_account = "東大の情報システムで使うアカウントです．「共通 ID」と呼ばれるアカウントです．UTokyo Accountは「10桁の共通ID＋@utac.u-tokyo.ac.jp」という形式をとります.各システムは，このアカウントでログインして使うのが基本になります．"
...
- **[ウイルス対策ソフトウェア包括ライセンス (UTokyo Antivirus License)](/antivirus/)**
  ...
  - 2025 年度版の提供は 2025 年 4 月 1 日から開始します．
    - 2025年3月までは2024年度のソフトウェアの申請になります．3月までに申請を行った場合でも，2025年度版をご利用いただくには2025年4月以降にもう一度申請を行っていただく必要があります．
