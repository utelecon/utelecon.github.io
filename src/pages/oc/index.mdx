...
- **任意の作業：メール・LINE・Slackと通知を連携する**  
  履修または担当しているコースで更新があったときに，メールやLINE，[UTokyo Slack](/slack/)で通知を受け取ることができます．設定手順については，「UTOLで通知を設定する（準備中）」を参照してください．
{:.procedure}
