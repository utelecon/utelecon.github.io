...
export const about_utokyo_account = "東大の情報システムで使うアカウントです．UTokyo Accountのユーザ名は，`0123456789@utac.u-tokyo.ac.jp`のように，10桁の数字（共通ID）の後に東京大学であることを表す記号`@utac.u-tokyo.ac.jp`を付けたもので表されます．"
