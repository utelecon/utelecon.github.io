...
- 無償サービスに送ってよいのは公開済みの情報や，組織と無関係な一般的な情報だけです
...
そのため情報漏洩のリスクは低いものですが，サービス業者にデータを送信しているというリスクは残ります．データが自ら管理する区域をでてはいけない，大学をでてはいけない，国境からでてはいけない，などの守るべき方針があればそれに照らして利用可否を判断すべきものです．
...
![モデルのセルフホスト](svg/L/ai_L7.svg){:.medium}
