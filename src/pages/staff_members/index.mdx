...
<b class="box">
2026/3/16 15:30から，説明会「<a href="/events/2026-03-16/">東京大学における情報システムとコミュニケーションツール</a>」を開催します．本ページとあわせてご参照ください．
{/* 2026/3/16 に，説明会「<a href="/events/2026-03-16/">東京大学における情報システムとコミュニケーションツール</a>」を開催しました．説明会の資料と動画をリンク先のページで提供していますので，本ページとあわせてご参照ください．*/}
</b>
...
東京大学ではZoomのライセンス契約を行っています．サインインして利用すると，個人で料金を負担することなく，授業や講習会などに有益な有償機能を利用することができます．ミーティングは，参加者数の上限が500人あるいは300人・時間の上限が30時間という形で開催できます．なお雇用形態の違いにより，利用することのできる機能が異なります．詳しくは，[Zoom](/zoom/#license)のページをご覧ください．
