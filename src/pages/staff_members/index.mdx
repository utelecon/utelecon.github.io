...
詳細については、後述の説明や utelecon の各ページをご参照ください。{/*教員の方は東京大学における情報システムの準備について（教員向け）をご参照ください．*/}
...
UTokyo Accountのユーザ名は，`0123456789@utac.u-tokyo.ac.jp`のように，10桁の数字（共通ID）の後に東京大学であることを表す記号@utac.u-tokyo.ac.jpを付けたもので表されます．
...
**[UTokyo Microsoft License （Office アプリ，OneDrive）](/microsoft/)**
