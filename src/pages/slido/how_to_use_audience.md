...
「Question AI」の欄の各項目を選択することで，AIによって入力した文章が以下のように書き換わります．
* **Improve**: 文章の誤字脱字を直したり，より自然で分かりやすい表現に整えてくれます．
* **Shorten**: 長文を要約して，要点だけのシンプルな質問にしてくれます．（文字数制限がある時に便利です）
* **Professional**: 目上の人や公式な場にふさわしい，礼儀正しい「敬語」や「硬い表現」に変換します．
* **Casual**: 少し砕けた，親しみやすい表現に変換します．
* **Joyful**: 文末に絵文字を追加して，元気で楽しげな表現に変換します．

質問・感想は匿名で送信できますが，名前を入力したい場合は，テキスト入力欄下部の「Your name (optional)」の欄を使ってください．ここで入力した名前は，他の参加者にも共有されます．
