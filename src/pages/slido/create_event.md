...
2. 画面上の「Create Slido」あるいは「New Slido」を選択してから，「Start date」にイベントの開始日，「End date」にイベントの終了日，「Give your slido a name」にイベントの名前を入力します．「Add your slido in a space」を選択することで，イベントを行うスペース（イベントを整理できる共有ワークスペースのこと）を選択することができます．
   
   <img src="img/schedule_slido.png">
4. 「Create Slido」あるいは「Schedule Slido」をクリックすると，イベントが作成されます．イベント画面右上の「Share」ボタンをクリックすると，イベントに参加するための専用ページのURLがクリップボードにコピーされるので，このURLを参加者に共有してください．参加者はURLにアクセスすることで，イベントに参加できます．<img src="img/share_event_url.png">なお，イベント情報の共有は，以下のような方法でも行うことができます．
