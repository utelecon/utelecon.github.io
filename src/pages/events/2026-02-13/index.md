...
- **当日の貼付**：ポスターはご自身で印刷・持参の上,**16：55まで**に指定の番号のボードに掲出ください.ボードの位置と番号は,当日会場でご確認ください
...
| 13:20-13:50   | Building with Azure OpenAI Codex-5:<br>Deployment to VS Code Integration<br>[資料](/en/events/2026-02-13/UsingAzureCodeAI_ver.2_p52added.pdf)<br> *2026/03/26 *2026/03/26 スライドp52追加（リモートSSHアクセスを使ってAzure Codexを利用する）| 山肩 洋子<br>（情報基盤センター・教授） |
