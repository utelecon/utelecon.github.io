...
- 説明（[目次](slides/00-index.pdf)・**動画**）
    1. アップデート全般、セキュリティ（田浦；[資料](slides/01-update-and-security.pdf)・**動画**）
    1. 東京大学で使われている代表的なクラウドサービスの活用について ～Zoom, Google, Microsoft, Slackなど～（竹内；[資料](slides/02-cloud.pdf)・**動画**）
