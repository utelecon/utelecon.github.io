---
title: UTOLの課題機能でAI利用範囲の設定が必須になります
---
...
本学では，生成AIの授業における利用について「\[2\] 授業や課題ごとに，言語生成系AI利用に対する教員のスタンスを明示する」とアナウンスしてきました（詳しくはuteleconのウェブページ「[AIツールの授業における利用について（ver. 1.0）](/docs/ai-tools-in-classes/)」をご覧ください）．そこで2026年度Aセメスターに向けて，UTOL(UTokyo LMS)で作成する「課題」において**AI利用範囲**機能の利用を開始し，以降に作成する課題において設定が必須になります．
...
| S4 | 草稿 | 提出物の草稿を作成させ，その後それを元に提出物に仕上げる |
...
| 範囲ラベル[^1] | 説明 | [AIAS](https://aiassessmentscale.com/)による分類名[^2] |
| :---- | :---- | :---- |
| T0 | AIは利用しない | No AI |
...
[^1]: Tn(nは整数)はS1からSnまでの場面でのAIの利用を許容することを意味します．
[^2]: AIASは「[The AI Assessment Scale (AIAS)](https://aiassessmentscale.com)」を指しています．

なお，表2のいずれの範囲にも当てはまらない場合は，出題する教員が当該課題におけるAI利用範囲を具体的に説明してください．

## 課題機能の変更点

### 担当教員・TA向け

担当教員やTAが操作する課題編集画面を図1，2に示します．課題を作成する際には表2のいずれかの範囲を図1のドロップダウンメニューから選択して下さい．
