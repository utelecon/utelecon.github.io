...
持ち込みPCあるいは，ユーザ利用端末のUSB-CポートにUSB-CハブのPC接続用コネクタを指すことにより，各種の機器が利用可能になります．USB-C充電が可能な持ち込みPCでは充電も可能です(最大出力85W)．
...
| 駒場 | 情報教育棟 | 2階小演習室2 |  | 25 | 20 |
| 駒場 | 情報教育棟 | 2階小演習室3 |  | 28 | 28 |
| 駒場 | 情報教育棟 | 2階小演習室4 |  | 21 | 10 |
