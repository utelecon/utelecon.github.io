...
2. Webブラウザが起動して「Googleにログイン」の画面が開くので，ECCSクラウドメールアドレス（`@g.ecc.u-tokyo.ac.jp`のメールアドレス）でログインしてください．
   ...
   ![](./google-drive-3.png){:.border}
3. 以下の画面が表示されたらログイン成功です．
   ![](./google-drive-4.png){:.border}
