...
ログイン後に表示される「ゲストアカウント向けリンク」で「UTokyo Account パスワード変更(利用者メニュー)」をクリックしてください．
「UTokyo Account 利用者メニュー」が表示されます．以降は「[初期パスワードを変更する](/utokyo_account/#change-initial-password)」を参照してください．
