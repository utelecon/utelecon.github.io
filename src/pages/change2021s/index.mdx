...
オンライン授業の円滑な実施を目的として，東京大学が提供する各種情報システムについて，ログイン方法を可能な限り UTokyo Account に統一してわかりやすくするとともに，その他必要な変更を行います．
...
以下の日程で切り替えを行い，現在ご利用いただいている共通ID（UTokyo Accountの先頭10桁の数字のみの部分）のアカウントは，UTokyo Accountで使えるように移行します．
