...
## コース名の表示について
担当教員の画面には，担当教員として登録したコースに関わらず「代表コース名」が表示されます（履修者には登録したコースが表示されています）．代表コース名しか表示されていなくても，子コースは正常に登録されています．なお代表コース名は， コーストップ画面から「コース設定 > コース設定」 を開き，「代表コース名変更」 から変更することができます．
