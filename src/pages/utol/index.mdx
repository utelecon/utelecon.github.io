...
- [外部ツールとの連携](students/integrations/)
  - [Zoomとの連携](students/integrations/zoom/)
  - [Slackとの連携](students/integrations/slack/)
  - [MATLAB Graderとの連携](students/integrations/matlab_grader/)
...
- [外部ツールとの連携](lecturers/integrations/)
  - [Zoomとの連携](lecturers/integrations/zoom/)
  - [Slackとの連携](lecturers/integrations/slack/)
  - [MATLAB Graderとの連携](lecturers/integrations/matlab_grader/)
...
UTOLでは，毎月第1火曜日の昼休み（12:20〜13:00）に定期メンテナンスを実施しています．第1火曜日の昼休み（12:20〜13:00）はサービスを停止する場合がありますので，この時間帯のご利用はお控えください．

また，定期メンテナンス以外にサービス停止を伴うメンテナンスを行う場合は，以下のWebページに事前にお知らせします．
- [システムの障害・メンテナンス情報](https://univtokyo.sharepoint.com/sites/utokyoaccount/SitePages/service-status.aspx) (閲覧には[UTokyo Account](/utokyo_account/)でのサインインが必要です)
- UTOLトップページの「重要なお知らせ」欄

ご理解とご協力のほど、よろしくお願いいたします。

## 規則

- [東京大学情報基盤センター学習管理システム利用規則](rule/)
