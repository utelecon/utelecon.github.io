...
<div class="box">
2024年5月以降，東京大学のシステムのほとんどで，UTokyo Accountの多要素認証を有効化していることが必須の利用要件となります．
授業受講への影響を避けるため，UTOLに関しては当面の間この措置は見送られる予定ですが，まだ多要素認証を有効化していない方は速やかに設定を行うようにしてください．設定方法は「[UTokyo Account多要素認証の初期設定手順](/utokyo_account/mfa/initial/)」で説明しています．
