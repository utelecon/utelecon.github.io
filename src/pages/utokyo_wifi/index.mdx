...
- 「申し訳ありませんが、サインイン中に問題が発生しました」または「Sorry, but we’re having trouble signing you in.」というエラーメッセージが表示され，サインインができない場合，毎年実施される情報セキュリティ教育を受講し，合格したと判定されていません．この場合は，まず情報セキュリティ教育に合格してから[アカウントを再発行・再設定](#reissue-account)してください．
