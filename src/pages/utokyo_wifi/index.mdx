...
- 以下の図のようなエラーメッセージが表示され，サインインができない場合，毎年実施される情報セキュリティ教育を受講し，合格したと判定されていません．この場合は，まず情報セキュリティ教育に合格してから[アカウントを再発行・再設定](/#reissue-account)してください．
- TODO: 図
- サインインした直後の画面にUTokyo Wi-Fiアカウントの有効期限が表示されます．有効期限が切れている場合は[アカウントを再発行・再設定](/#reissue-account)してください．
- サインインした直後の画面にUTokyo Wi-Fiアカウントが表示されない場合，
...
UTokyo Wi-Fiが削除された場合，UTokyo Wi-FiアカウントメニューからUTokyo Wi-Fiアカウントを再び発行し，新しく発行されたアカウントを端末に再び設定する必要があります．
