...
UTokyo Wi-Fiとは，東京大学の構成員が教育・研究などの大学の活動を目的として利用できるWi-Fiサービスです．現在，キャンパス内のほとんどの建物で利用可能になっています．「[東京大学無線ネットワークシステム（UTokyo WiFi）利用規程](https://www.u-tokyo.ac.jp/adm/dics/ja/wifi_termsofuse.html)」に従って利用してください．
