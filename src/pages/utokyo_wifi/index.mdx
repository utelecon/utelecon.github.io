...
上記のいずれにも当てはまらない場合，お使いのUTokyo Wi-Fiアカウントには問題は無いようです．UTokyo Wi-Fiの一時的な障害や，お使いの機器の不具合が原因である可能性があります．
...
- 2回目以降で突然接続ができなくなった場合は，本ページの「[以前は接続できていたのに急にできなくなった場合](#suddenly-cannot-connect)」を参照してください．
