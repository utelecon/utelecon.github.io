...
- 2回目以降，なにもしていないのに急に接続ができなくなるなどの問題が発生した場合は，まず以下の2点を確認してください．
    1. UTokyo Wi-Fiアカウントの有効期限は翌年度の４月末までです．
    2. 毎年実施される情報セキュリティ教育を所定の期間内に受講・合格しなかった場合は，UTokyo Wi-Fiアカウントが削除されています（2023年度は8月9日に削除されました）．この場合は，まず情報セキュリティ教育に合格してください．
    - もしも上の2つのいずれかに該当した場合は，アカウントを再発行し，端末に再設定してください．再発行・再設定の手順は利用開始の手順の手順2,3と同様です．
        - なお，手順3において以前のUTokyo Wi-Fiアカウントの情報を機器が記憶してしまっており，情報を変更できない（新たなユーザーID・パスワードを入力するための画面が出ない）場合，一度Wi-Fiのアカウント情報を削除してください．具体的な削除方法はOSや機器の種類によって異なりますので，[端末の種類ごとの説明ページ](#procedure-by-device-type)の手順3を参照してください．これらのページに記載がない場合は、それぞれの機器のマニュアルを参照してください．
