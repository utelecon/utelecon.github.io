...
なお，UTokyo Wi-Fiは，各個人が占有して利用する機器でのみ利用可能で，**複数人が共用する機器での利用は禁止です**．共用機器での利用は，UTokyo Wi-Fiアカウントを取得した本人以外に利用させることになり，利用規程で禁止されているアカウントの貸与にあたるためです．ただし，OSのユーザーアカウントが個人別に設定されていて，UTokyo Wi-Fiアカウントが取得した本人以外に利用できない，という状況であれば問題ありません．
