...
UTokyo Wi-Fiとは，東京大学の構成員が教育・研究を目的として利用できるWi-Fiサービスです．現在，本郷・駒場・柏などのキャンパスのほとんどの場所で利用できます．UTokyo Wi-Fiを利用する前に確認すべきことが[利用の前に](#before-to-use)にまとまっていますので，適宜確認してください．
