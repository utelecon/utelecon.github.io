...
- UTokyo Wi-Fiを利用できるのは，[UTokyo Account](/utokyo_account/)を持つ東京大学の構成員（教職員・学生）です．
    - UTokyo Accountの多要素認証を有効化していない場合，アカウントを発行することができません．手順については[こちら](https://utelecon.adm.u-tokyo.ac.jp/utokyo_account/mfa/initial/)を参照してください．
...
セキュリティの観点より，UTokyo Wi-Fiの利用にあたっては，UTokyo Accountの多要素認証（MFA）の有効化を必須としています．
