...
UTokyo Wi-Fiを利用するには，年度ごとにUTokyo Wi-Fiアカウントを発行する必要があります．この「準備編」では，UTokyo Wi-Fiアカウントを発行する手順について説明します．

アカウントは「UTokyo Wi-Fiアカウントメニュー」を利用してご自身で発行していただきます．アカウントのユーザーID・パスワードは，「UTokyo Wi-Fiアカウントメニュー」の申請直後の画面で確認できるほか，メールでも通知されます．なお、発行したUTokyo Wi-Fiアカウントを利用して複数の機器でUTokyo Wi-Fiに接続することができます．
...
1. このページの「[準備編：UTokyo Wi-Fiアカウントの発行を申請する](#initial-setup-apply)」に従ってUTokyo Wi-Fiアカウントメニューからアカウントを再発行してください．
...
2. このページの「[利用編：UTokyo Wi-Fiに実際に接続する](#initial-setup-connect)」に従って，機器にアカウントを再度設定してください．
