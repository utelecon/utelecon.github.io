...
4. アプリを起動すると，「Search for your Organization」の画面が表示されます．この画面で検索を行い，「The University of Tokyo」を選択してください．すると「Select a profile」の画面が表示されるので，「UTokyo Wi-Fi Account」を選択してください．
