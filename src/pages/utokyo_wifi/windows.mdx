...
<div class="box">
2025年10月14日をもってWindows10のサポート期間が終了しました（[詳細](/notice/2025/1014-win10office-eol/)）．サポートが終了したOSやアプリケーションにはセキュリティ修正プログラムの提供などが行われなくなり，これを利用し続けることには重大な問題があります．このページにはまだWindows10についての説明がありますが，適宜読み替えて利用してください．
</div>
