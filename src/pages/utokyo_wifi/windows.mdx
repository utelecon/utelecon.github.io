---
title: WindowsでUTokyo Wi-Fiを利用する
breadcrumb:
  title: Windowsで利用する
---
...
<Intro kindOfTerminal="Windowsの端末" confirmedTerminal=""/>
...
![](img/windows11-selectssid.png){:.medium.center.border}
...
![](img/windows11-createprofile-2.png){:.medium.center.border}
