---
title: macOS 26/15でUTokyo Wi-Fiを利用する
breadcrumb:
  title: macOS 26/15で利用する
---
...
<Intro kindOfTerminal="macOS 26 Tahoe/macOS 15 Sequoiaの端末" confirmedTerminal="（macOS 26 Tahoeが搭載されたMacBook Pro）"/>
