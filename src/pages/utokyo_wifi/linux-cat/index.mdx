...
紹介する手順の動作やスクリーンショットは、Ubuntu 24.04 LTSを使用している環境で確認しています。
...
4. 事前準備で用意したUTokyo Wi-Fiアカウントの情報を入力し，「OK」を押します．
...
6. 間違った認証情報を入力したり，アカウントの有効期限が切れて新しいアカウントを発行したりした場合は，もう一度手スクリプトを実行して正しい情報を入力すると，既存の設定が上書きされ，誤った情報を修正できます．
