...
クラスサポーターとは，オンライン授業のスムーズな進行を支援する学生サポーターのことで，主にTAの付いていないオンライン授業について，事前の機材テスト，授業中のウェブ会議システムトラブルへの対応，ライブ授業中に学生から届く質問のピックアップなどを補佐します．（詳細はuteleconの「[クラスサポーター制度のご案内](/supporters/class_a/)」をご参照ください）  
