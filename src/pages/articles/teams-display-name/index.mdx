...
UTokyo Microsoft Licenseのもとで教職員が利用できるTeamsでは，デフォルトの表示名は利用者自身では変更できません．このデフォルトの表示名は，人事手続きで用いられる氏名が自動的に連携して設定される仕組みで管理されているためです．

なお，万一デフォルトの表示名に誤りがある場合は，所属先の人事担当に相談してください．
