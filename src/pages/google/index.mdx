...
- **YouTube**：動画配信サービス
- **Google Meet**：Web会議
- **Gemini**: 生成AIサービス ※無料で提供される「その他の Google サービス」
...
- **Gemini**
    - [ECCSクラウドメールでのGeminiの利用について](https://www.ecc.u-tokyo.ac.jp/announcement/2024/06/04_3635.html)（ECCS広報）：情報基盤センターによる説明ページです．
        - ※2024年9月現在，ECCSクラウドメールアカウントで Gemini を使用する場合，ユーザのデータが AI モデルの改良に使用されることはなく，AIモデルを改良する目的で人間によるレビューを受けることもありません．詳しくは下記FAQペ0時を確認してください．
