...
加えて，ファイルを共有する際に推奨される利用方法をケース別に説明したページ「**[Googleドライブ ファイル共有のおすすめの利用方法](recommendation)**」や，ファイル共有方針の提案として生産性や安全性を高める使い方を説明するページ「[クラウドストレージを用いた新しいファイル共有方針の提案](/online/topics/share_policy)」も必要に応じて参照してください．
