...
A: その共有ドライブは代表者がいない状態になります．代表者がいない共有ドライブをそのまま放置すると，一定時間経過後に削除されますが，共有ドライブの管理者は自分を代表者に割り当てることができるようにするので，容易に移行できるようになります．代表権を取得する方法については，簡易マニュアル「[共有ドライブの代表権取得](https://docs.google.com/document/d/1jnZv6sKALEXvui12y-KSTvYsu0XxG4U12q5RCD5oYB8/edit#heading=h.8odxz0wha1ko)」を参照してください．
