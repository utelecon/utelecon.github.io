...
ECCSクラウドメールのアカウントに対するGoogle Workspace for Education Plusのライセンスの付加は，利用者からの申請に基づいて行なっています(2026年11月2日から学生用と教職員用のライセンスは統一されます．また，申請なしに全ユーザにライセンスを付与します．また，先行して2026年10月1日から一部のユーザについて申請がなくてもライセンス付与を実行します)．
