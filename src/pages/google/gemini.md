...
東京大学のGoogle Workspaceの組織契約の中でGoogle社から無償で提供される「その他のGoogleサービス」としての利用以外に，2026年2月24日からGoogleドキュメント, Googleスライド, GoogleフォームでGeminiが使えるようになりました．利用にあたっては，[Googleドキュメント, Googleスライド, GoogleフォームでGeminiが使えるようになりました](/notice/2026/0302-gemini-gws/)のページを御覧ください．
