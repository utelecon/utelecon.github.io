...
3. 画像，動画の挿入
   ...
   * 類似の機能として，質問内や選択肢内に画像を挿入する機能もありますが，挿入する画像が質問や選択肢と直接関連するかどうかが異なります．質問内や選択肢内への画像挿入については，後述「[質問編集時の便利機能](#useful_features_for_question_editing)の画像の挿入」をご参照ください．
4. セクションの追加
   * 「セクションの追加」ボタンからは，質問をセクションと呼ばれる単位に分割することで，別々のページに表示したり，これまでの質問の回答によって異なる質問をしたりすることができます．
   * 質問の回答に応じたセクションの移動に関しては，後述「[質問編集時の便利機能](#useful_features_for_question_editing)のセクションへの移動」をご参照ください．
