...
![アンケートタブ](./createbefore2.png)

3. 「投票またはクイズ」を選択し、「作成」を押してください。
![投票とクイズの選択画面](./createbefore3.png)

4. 投票のタイトルや質問文など、必要な事項を入力してください。
![投票の作成画面](./createbefore4.png)
...
![zoom画面下部](./lowerpart.png)

2. 以下のようなウィンドウが表示されます。右上の「＋」を押してください。
![投票一覧ウィンドウ](./createwhile2.png)

3. 投票のタイトルや質問文など、必要な事項を入力してください。
![投票作成ウィンドウ](./createwhile3.png)
