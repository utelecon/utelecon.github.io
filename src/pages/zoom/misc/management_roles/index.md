...
<ul>
<li>ホストが開催するすべてのミーティングに対して有効にする場合</li>
<ol>
<li>Zoom アカウントの<a href="https://u-tokyo-ac-jp.zoom.us/profile/setting">設定</a>ページにアクセスします</li>
<li>「ミーティングのスケジュール」欄までスクロールします</li>
<li>「ホストより先に参加することを参加者に許可」を有効にします。</li>
<li>"Participants can join"項目では、参加者が入室することのできる時間を制限することができます(例：ミーティング開始時刻の5分前以降に入室可能)。<strong>特に制限を設けるつもりがない場合、「任意の時間」に設定します</strong></li>
</ol>
<img src="join_before_host_global.png">
<li>ホストが開催するミーティングのうち、特定のミーティングについて有効にする場合</li>
ミーティングをスケジュールする画面、もしくは既存のミーティングの編集画面において、「オプション」欄の「参加者に参加を許可する」を有効にして、「保存」を選択します。横のプルダウンメニューでは、参加者が入室することのできる時間を制限することができます（例：ミーティング開始時刻の5分前以降に入室可能）。<strong>特に制限を設けるつもりがない場合、「任意の時間」に設定します</strong>
<ul>
<li>ブラウザでの設定</li>
<img src="join_before_host_meeting_browser.png">
<li>アプリでの設定</li>
<img src="join_before_host_meeting_app.png">
</ul>
</ul>
</details>
...
1. Zoom アカウントの[プロフィール](https://zoom.us/profile)ページにアクセスします
2. "Meeting"欄が表示されるまで下にスクロールします
3. "Meeting"欄のうち、「ホストキー」の横にある目のアイコン（a）をクリックします。表示された6桁の数字がホストキーです。もし、ホストキーが意図しない他者に知られてしまった場合などで、新しくホストキーを設定することを希望する場合、右側の「編集」(b)から設定することができます。
![](host_key.png)
