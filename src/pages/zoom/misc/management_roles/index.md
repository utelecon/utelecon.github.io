...
<ul>
<li>ホストキーは、代わりにホストになる参加者がホストより前にミーティングに参加する場合に用いるものです</li>
<li>すでにホストが参加しているミーティングで、ホストを交代することを望む場合は、「<a href="#transfer_host">ホストの譲渡</a>」をご利用ください</li>
</ul>

<details>
<summary>ホストの前に参加を有効にする方法</summary>
<ul>
<li>（オプション）「ホストの前に参加」をデフォルト設定にする</li>
この項目を設定することで、今後スケジュールするミーティングの「ホストの前に参加」に関するデフォルト設定が有効になります。この項目を設定しなくても各ミーティングについて個別に「ホストの前に参加」を有効にすることは可能です。<br>
また、この項目を設定することで、<a href="#participants_can_join">各ミーティングについて参加者が入室することのできる時間を制限することができる機能を有効に</a>できるようになります（例：ミーティング開始時刻の5分前以降にのみ入室可能）。この項目を設定しない場合、そうした機能を有効にすることはできません。
<ol>
...
<li><a name="participants_can_join">（オプション）"Participants can join"を有効にする</a></li>
「ホストより先に参加することを参加者に許可」を有効化した場合に表示される"Participants can join"では、参加者が入室することができる時間についての制限をかける機能を有効にすることができます。<strong>ここでの決定は、各ミーティングで制限をかけることができるようになる機能の有効・無効に関わるものであって、即座に個別のミーティングにおける入室時間の制限につながるわけではありません。</strong>こうした機能を今後利用する予定がある場合は、有効にすることを推奨します。
...
<li>ホストが開催するミーティングのうち、特定のミーティングについて有効にする場合</li>
<ul>

<li>ブラウザでの設定</li>
<ol>
<li>Zoom ウェブポータルの「<a href="https://u-tokyo-ac-jp.zoom.us/meeting">ミーティング</a>」ページにアクセスします</li>
<li>新しくミーティングを作成する場合は、「ミーティングをスケジュール」を選択します。以前に作成したミーティングの設定を確認・変更する場合は、一覧に表示されているミーティングにカーソルを合わせると右側に「編集」ボタンが表示されるので、このボタンを選択します</li>
<img src="schedule_or_edit_meeting_on_web.png">
...
横のプルダウンメニューでは、参加者が入室することのできる時間を制限することができます。<strong>特に制限を設けるつもりがない場合、「任意の時間」に設定します。</strong>
...
<li>アプリでの設定</li>
<ol>
<li>新しくミーティングを作成する場合は、「ホーム」タブの「スケジュール」を選択します。以前に作成したミーティングの設定を確認・変更する場合は、「ミーティング」タブで該当のミーティングを選択し、「編集」を選択します</li>
<ul>
<li>新しくミーティングを作成する</li>
<img src="schedule_meeting_app.png">
<li>以前に作成したミーティングの設定を確認・変更する</li>
...
<ul>
<li><a href="#participants_can_join">"Participants can join"</a>を有効にしている場合</li>
「開始時刻前に[プルダウンメニュー]に参加することを参加者に許可します」を有効にします。プルダウンメニューでは、参加者が入室することのできる時間を制限することができます。<strong>特に制限を設けるつもりがない場合、「任意の時間」に設定します。</strong>
...
2. 新しくミーティングを作成する場合は、「ミーティングをスケジュール」を選択します。以前に作成したミーティングの設定を確認・変更する場合は、一覧に表示されているミーティングにカーソルを合わせると右側に「編集」ボタンが表示されるので、このボタンを選択します
![](schedule_or_edit_meeting_on_web.png)
3. ミーティングのスケジュール（編集）画面で「オプション」の項目の [表示] を選択します
...
#### アプリから代替ホストを設定する
1. 新しくミーティングを作成する場合は、「ホーム」タブの「スケジュール」を選択します。以前に作成したミーティングの設定を確認・変更する場合は、「ミーティング」タブで該当のミーティングを選択し、「編集」を選択します
    - 新しくミーティングを作成する
![](schedule_meeting_app.png)
    - 以前に作成したミーティングの設定を確認・変更する
![](edit_meeting_app.png)
2. ミーティングのスケジュール（編集）画面で「詳細オプション」を選択します
...
<<<<<<< HEAD:src/pages/zoom/misc/management_roles/index.md
### スケジュール作成特権を付与する方法
...
他のユーザーにスケジュール作成特権を設定する具体的な手順は以下の通りです。
...
5. （オプション）追加するユーザーに
>>>>>>> Add Participants can join settings:zoom/misc/management_roles/index.md
