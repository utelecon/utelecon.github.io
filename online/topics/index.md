...
- **[オンラインのグループディスカッションで生じやすい問題とその対策案](/articles/group-discussion/)**: オンラインのグループディスカッションで生じやすい，対面には無いオンライン特有の問題と，授業の工夫で対策する方法を紹介します．
- **[オンラインのグループディスカッションでワークシートを活用する](/articles/group-discussion-worksheet/)**: クラウド上の複数人が同時に書き込めるワークシートを使い，各グループの議論の様子をリアルタイムで把握したり，授業後に記録として使ったりする方法を紹介します．
