...
<b class="box">
（2023年5月）この編入（移行）手続きについては，利用数が落ち着いてきていることから，Slack側との協議により，今後数ヶ月程度で順次縮小・終了していく方針となりました．UTokyo Slackの運用開始時における経過措置的な性格もあり，継続的な実施が難しい状況ですので，ご理解をお願いいたします．利用を検討されている方は，お早めの申し込みにご協力ください．
</b>
...
6月締切分は**6月8日（木）正午**を申し込み締切とし，締切後数日以内に抽選結果を発表します．
...
本ページの説明をすべて熟読の上，以下のフォームからお申し込みください．6月締切分は**6月8日（木）正午**を申し込み締切とし，以降の送信は翌月分の申し込みとして取り扱います．
