...
- 申し込み締切：9月9日（金）
- 抽選結果通知：<del>9月12日（月）</del> <ins>9月13日（火）</ins>

（参考）9月受付分の申込数は42件でした．

10月以降のスケジュールは，追ってこのページを更新してお知らせします．
...
- 管理の都合上，ワークスペースのプライマリーオーナー権限が「UTokyo Slack Primary Owner」という管理用の特別なアカウントに移譲されます．
    ...
    - 移譲は編入（移行）完了後しばらくすると行われます．ワークスペース側で特別な操作は不要ですが，その旨の連絡が届く場合がありますので，あらかじめご理解の上，もし承諾を求められた場合は速やかにご承諾ください．

## 申し込みフォーム
{:#form}

9月受付分は9月9日（金）に締め切りました．10月以降のスケジュールは，追ってこのページを更新してお知らせします．
