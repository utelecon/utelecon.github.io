...
編入（移行）にあたっては，UTokyo Slackにおけるワークスペース運用の制約やルールに沿って利用できることが条件となります．特に，UTokyo Slackでは，**UTokyo Accountを持っている構成員のみが利用できる（ワークスペースのメンバーとなれる）** ことにご注意ください．その他，編入（移行）後のワークスペースには，**「[UTokyo Slackにおけるワークスペースの作成と運用](workspace)」のページに記載されている注意事項などが適用されることになりますので，必ずこのページをすべて熟読**した上で手続きを行ってください．
