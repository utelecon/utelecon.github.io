...
また，アカウントを作る必要がある場合，**大学の Zoom アカウントの作成方法は特殊**なので，<font color="red">まず<a href="create_account" target="">このページ</a>をよく読んでアカウントを作ってください</font>（現在は一部の新入生は招待メールが送られていないため，少々お待ち下さい）．  
