...
* 3/24から25にかけて全学生に対して会議ツール Zoom 登録を行いました（一部の新入生は未登録で，後日登録予定です）．学生の皆さんの ECCSクラウドメールに招待状が届いています．大学のZoomアカウント[作り方のページ](create_account)を参考に**必要に応じて**アカウントを作成してください．
