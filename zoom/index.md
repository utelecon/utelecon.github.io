...
### URL を使って参加する
* 会議室の URL にアクセスします
* Web ブラウザー上で Zoom Meetings を開くを押します（ZOOM がインストールされてない場合は，その画面からダウンロード可能であるため，そのままダウンロードして ZOOM をインストールします）  
...
* 以下の情報を設定してミーティングをスケジュールする．以下，特に補足が必要な点に絞って説明します
