...
**[＜意向調査回答フォーム＞](https://tinyurl.com/y76zv37g)** ※Microsoftのサインイン画面では、 共通ID(10桁の数字)@utac.u-tokyo.ac.jp を入力してください。
...
- 〆切(2月5日)までに継続利用希望の回答をいただいた方には、2月10日頃に利用許可をメールでご連絡いたします。
...
- If you answer the Form till 2/5, we'll send the permission to use by e-mail around 2/10.
