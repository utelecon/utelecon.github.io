...
- 以下の「UTokyo WiFiアカウントメニュー」からUTokyo Accountでサインインしてください．
- 「新規申請」ボタンを押してください．
- 「通知用メールアドレス」の欄に，手順2で登録したメールアドレスが表示されているので，確認してください．このメールアドレスに，UTokyo WiFiへの接続に必要なアカウント情報（ユーザーID，パスワード）が書かれた通知メールが届きます．
- 「申請」ボタンを押して，アカウントを新規に取得してください．
- しばらく待つと通知メールが届きます．
...
- 手順1で用意した端末のWi-Fi接続設定画面で，UTokyo WiFiを選んでください．
- 場合によっては，証明書を確認したり，[接続の詳細な設定の節](#connect-configuration) に書かれた情報を利用する必要があるかもしれません．
- 接続しようとするとユーザーIDとパスワードを聞かれるので，手順3で届いたメールに書かれたアカウント情報を入力します（UTokyo Accountの情報ではありません）．
