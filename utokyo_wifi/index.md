...
- 以前のアカウントでは利用できていたが，アカウントを新たに発行してからUTokyo WiFiに接続できなくなることがあります．この場合，以前のUTokyo WiFiアカウントの認証情報を機器が記憶してしまっていることが原因として考えられるため，Wi-Fiの認証情報を削除してください．具体的な削除方法はOSや機器の種類によって異なります．それぞれの機器のマニュアルを参照してください．なお，WindowsやiOSについては，それぞれ[ECCS相談員のページ](https://www.sodan.ecc.u-tokyo.ac.jp/faq/utokyo-wifi-win10/)と公式ヘルプ「[iPhone、iPad、iPod touch、Mac で Wi-Fi ネットワークの設定を削除する方法](https://support.apple.com/ja-jp/HT208941)」も参考にしてください．
