...
東京大学には，UTokyo WiFiの他にも学内で共通に利用できる無線LANサービスがあります．東京大学構成員および来学者は[東京大学での無線LAN利用](https://www.u-tokyo.ac.jp/adm/dics/ja/wlan.html)のページを参照し適切に利用してください．
...
### 共用端末での利用について
UTokyo WiFiは，各個人が占有する端末でのみ利用可能で，**複数名が共用する端末での利用は禁止です**．これはUTokyo WiFiの利用規程で，アカウントの貸与を禁止しているためです．ある個人のUTokyo WiFiアカウントが設定された端末はアカウントを取得した本人が利用し，第三者に利用させることのないよう，注意してください．ただし，共用する端末であっても，端末のユーザアカウントが複数あり，利用者本人のUTokyo WiFiアカウントがそれぞれのユーザアカウントに設定されている場合は問題ありません．
...
<ul>
  ...
  <ul>
    ...
    <li>ただし，古い端末や上記以外の電子機器では接続ができないことがあります．接続にあたっては端末のOSやドライバのアップデートを確認し，適切に更新して利用するようにしてください．</li>
    <ul>
...
<ul>
  ...
  <ul>
    <li>手順3以降は，上の手順でメールアドレスを登録した翌日以降に作業してください．</li>
  </ul>
</ul>
...
### アカウントの有効期限等
{:#expiration}
- **UTokyo WiFiのアカウントは半年に一度，4月末と10月末に失効します**．毎年4月1日，10月1日以降に，半年後まで有効なUTokyo WiFiアカウントが新たに発行できるようになるので，時期が来たら「UTokyo WiFiアカウントメニュー」から「新規申請」ボタンを押して，アカウントを新たに発行してください．この新しく発行されたアカウントのユーザーID，パスワードを利用している機器に再度設定し，引き続きUTokyo WiFiに接続できることを確認してください．
- ただし，その年度の情報セキュリティ教育を受講していない場合，10月1日以降にアカウントを新たに発行することができず，半年間近くにわたってUTokyo WiFiを利用することができなくなります．情報セキュリティ教育の受講時期は学生は5月から，教職員は7月からです．受講の方法など詳細については「[情報セキュリティ教育](#jouhou-security)」を参照してください．
- 以前のアカウントでは利用できていたが，アカウントを新たに発行して以降，UTokyo WiFiに接続できない場合があります．
  - 機器が以前のアカウントの認証情報を記憶してしまっていることが原因として考えられます．
  - この場合，Wi-Fiの認証情報を削除する必要がありますが，その方法はOSや端末の種類によって異なります．それぞれの端末のマニュアルを参照してください．
  - WindowsやiOSについては，それぞれ[ECCS相談員のページ](https://www.sodan.ecc.u-tokyo.ac.jp/faq/utokyo-wifi-win10/)と公式ヘルプ「[iPhone、iPad、iPod touch、Mac で Wi-Fi ネットワークの設定を削除する方法](https://support.apple.com/ja-jp/HT208941)」も参考にしてください．
- UTokyo WiFiのアカウントは削除できませんが，再度「UTokyo WiFiアカウントメニュー」の「新規申請」ボタンを押して，アカウントを新たに発行することで既存のアカウントは無効になります．
...
### セキュリティ対策
- 本学のネットワークでは，全学セキュリティファイアウォール等による情報セキュリティ確保が図られています．
...
### 利用端末数
- UTokyo WiFiのアカウントあたりの利用端末数には上限はありません．
...
- はじめて接続する際に問題が発生している場合は，本ページの「[利用開始までの手順](#initial-setup)」の手順を丁寧に読みなおしてください．また，機器ごとの詳細な接続方法が掲載されている[ECCS相談員のページ](https://www.sodan.ecc.u-tokyo.ac.jp/faq/category/wireless-lan/)も，必要に応じて参照してください．
  - 2回目以降の接続で問題が発生した場合は，本ページの「[利用開始までの手順](#initial-setup)」
