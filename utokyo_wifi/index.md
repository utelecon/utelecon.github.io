...
### 共用する機器での利用について
UTokyo WiFiは，各個人が占有する機器でのみ利用可能で，**複数名が共用する機器での利用は禁止です**．これはUTokyo WiFiの利用規程で，アカウントの貸与を禁止しているためです．ある個人のUTokyo WiFiアカウントが設定された機器はアカウントを取得した本人が利用し，第三者に利用させることのないよう，注意してください．ただし，共用する機器であっても，機器のユーザアカウントが複数あり，利用者本人のUTokyo WiFiアカウントがそれぞれのユーザアカウントに設定されている場合は問題ありません．
...
<ul>
  ...
  <ul>
    通常のノートパソコンやスマートフォン，タブレットでは基本的にUTokyo WiFiの利用が可能です．ただし，古い機器や上記以外の電子機器では接続ができないことがあります．接続にあたってはその機器のOSやドライバのアップデートを確認し，適切に更新して利用するようにしてください．例えば，WPA2-Enterprise方式に対応していない機器は接続できません．
  </ul>
</ul>
...
<ul>
  ...
  <ol>
    <li>
      UTokyo WiFiアカウントの発行にはあらかじめメールアドレスの登録が必要です．以下の手順に従って登録を行ってください．受信できるメールアドレスが既に登録されている場合は，そのままにして手順3に進んで構いません．
      <ul>
...
### アカウントの有効期限等
{:#expiration}
- **UTokyo WiFiのアカウントは半年に一度，4月末と10月末に失効します**．毎年4月1日，10月1日以降に，それぞれ10月末頃，4月末頃まで有効なUTokyo WiFiアカウントが新たに発行できるようになるので，時期が来たら上記の手順3以降と同様にして，アカウントを新たに発行してください．この新しく発行されたアカウントのユーザーID，パスワードを，利用している機器に再度設定してください．
...
- 以前のアカウントでは利用できていたが，アカウントを新たに発行して以降，UTokyo WiFiに接続できない場合があります．
  ...
  - この場合，Wi-Fiの認証情報を削除する必要がありますが，その方法はOSや機器の種類によって異なります．それぞれの機器のマニュアルを参照してください．
