...
- UTokyo WiFiを利用できるのは，UTokyo Accountを持つ東京大学の構成員（教職員・学生）です．
    - 情報セキュリティ教育を受講していない場合，構成員であっても利用が停止されることがあります．詳細は [「情報セキュリティ教育」の項](#jouhou-security) を参照してください．
...
**手順1:** 接続するための端末を準備する．
- 通常のノートパソコンやスマートフォン，タブレットでは基本的にUTokyo WiFiの利用が可能です．
- ただし，古い端末や上記以外の電子機器では接続ができないことがあります．接続にあたっては端末のOSやドライバを適切に更新して利用するようにしてください．
    - 例えば，WPA2-Enterprise方式に対応していない端末は接続できません．
...
- 以下の「UTokyo WiFiアカウントメニュー」からUTokyo Accountでサインインし，「新規申請」ボタンを押して，アカウントを新規に取得してください．なお既にアカウントを持っている場合，または2台目以降の場合は発行手続きは必要ありません．
- UTokyo WiFiのアカウントの情報（ユーザ名, パスワード）が記載されたメールが前もって登録されたメールアドレスに届きます．有効期限は半年で，毎年4月末，10月末に失効します．
<div style="border: 2px solid currentcolor; margin: 1em 0 2em; padding: 0.5em; font-weight: bold; text-align: center;">
<a href="https://netacm.adm.u-tokyo.ac.jp/secure/user_applies/index/1/">UTokyo WiFiアカウントメニュー（国内のみ）</a>
</div>
<details><summary>アカウントメニューにアクセスできない場合</summary>
<ul>
    <li> アカウントメニューは一般的に国内ネットワークと見なされるネットワークからのみアクセスすることができます．アクセスができなかった場合には，学内のECCS端末を利用した申請を検討してください．詳しくは <a href="https://www.ecc.u-tokyo.ac.jp/guest_account.html">ECCSのウェブサイト</a> をご確認ください．</li>
    <li> 以下のような画面が出てアクセスできない場合
        <img src="img/account_menu_login_denied.png" class="small">
        <ul>
            <li> 情報セキュリティ教育を受講していないため，アカウントが停止されています．詳細は <a href="#jouhou-security">「情報セキュリティ教育」の項</a> を参照してください．</li>
        </ul>
    </li>
</ul>
</details>
<details><summary>メールが届かない場合</summary>
<ul>
    <li> 迷惑メールフォルダなどに紛れ込んでいないかどうか，再度確認してください．</li>
    <li> メールアドレスによっては正しくメールが配送されないケースがあります．特に，もしiCloudのメールアドレスを登録している場合は，ECCSクラウドメールなどに変更してください．</li>
    <li> UTokyo WiFiのアカウントは，学生の場合は学務システムに，教職員等の場合は人事情報システムに，それぞれ前日までに登録されているメールアドレスに対して通知されます．意図したメールアドレスが正しく登録されているかどうか確認してください．
        <ul>
            <li> なおメールアドレスを登録・変更しただけではメールは再送されません．メールアドレスを変更した翌日以降に改めて「新規申請」ボタンを押してアカウントを再発行してください．</li>
        </ul>
    </li>
</ul>
</details>

**手順4:** UTokyo WiFiが接続可能なネットワークとして表示されている場所で接続をする．
以下の記述に従って，教室などUTokyo WiFi（SSIDがUTokyo-WiFiとなっているワイヤレスネットワーク）が見えるところで接続を行います．
接続しようとするとアカウント情報を聞かれるので，手順3で届いたメールに書かれたアカウント情報を入力します．
...
<details><summary>端末での設定方法が分からない場合</summary>
<ul>
    <li> PCでの設定方法等は <a href="https://www.sodan.ecc.u-tokyo.ac.jp/?page_id=3996">ECCS相談員のページ</a> を参照してください．
    </li>
    <li> eduroamと同様にして設定することができます．<a href="https://www.eduroam.jp/for_users/">eduroamのページ</a> の利用の手引きにOSごとの設定方法が書いてありますので，"eduroam"を"UTokyo-WiFi"に読み替えることで設定が可能です．
    </li>
</ul>
</details>
<details><summary>以前に接続できていたが，アカウントを再発行してから繋がらない場合</summary>
<ul>
    ...
    <li> 利用する機器が最新の状態ではないために起こる場合もあります．
        <ul>
            <li> 古いMacOS，Windows 7以前，アップデートをしていない機器（スマホ等）は接続までに，最新のバージョンにしてください．</li>
        </ul>
    </li>
</ul>
</details>
...
<!-- 見出しの日本語は仮 -->
### アカウントの有効期限
- **UTokyo WiFiのアカウントは半年に一度，4月末と10月末に失効します**．毎年4月1日，10月1日以降に，半年後まで有効なUTokyo WiFiアカウントが再発行できるようになります．時期が来たら「UTokyo WiFiアカウントメニュー」から「新規申請」ボタンを押して再発行してください．アカウントを再発行したら，新しく発行されたユーザ名，パスワードを端末に再度設定してください．
    - ただし，その年の情報セキュリティ教育を受講していない場合，10月1日から「UTokyo WiFiアカウントメニュー」にサインインできなくなり，したがって再発行ができません．該当者は [「情報セキュリティ教育」の項](#jouhou-security) を参照し，必ず受講するようにしてください．
- また，UTokyo WiFiのアカウントは削除できません．しかし，再度「新規申請」ボタンを押してアカウントを再発行することで，既存のアカウントは無効になります．
